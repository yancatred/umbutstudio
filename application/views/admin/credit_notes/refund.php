    ...
    <div class="panel_s">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <?php
                    echo render_input('amount', 'refund_amount', isset($refund) ? $refund->amount : $credit_note->remaining_credits, 'number', ['max' => (!isset($refund) ? $credit_note->remaining_credits : $credit_note->remaining_credits + $refund->amount), 'min' => 0]); ?>
                ...
                <div class="col-md-6">
                   <div class="form-gruoup">
                    ...
                    <textarea name="note" class="form-control" rows="8" id="note"><?php if (isset($refund)) {
                        echo clear_textarea_breaks($refund->note);
                    } ?></textarea>
                </div>
            </div>
        </div>
