  ...
  <div class="card">
    <table class="tree">
      <tbody>
        ...
        <tr>
          <td colspan="3">
            <h4 class="text-center no-margin-top-20 no-margin-left-24"><?php echo _l('profit_and_loss_as_of_total_income'); ?></h4>
          </td>
          <td></td>
          <td></td>
        </tr>
        ...
        <tr class="border-top">
          <td></td>
          <td colspan="2" class="text-center th_total_2 text-bold"><?php echo _l('total'); ?></td>
          <td></td>
        </tr>
