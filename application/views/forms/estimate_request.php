...
<body
    class="estimate-request-form <?php echo $form->form_key . ($this->input->get('styled') === '1' ? ' styled' : ''); ?>">
                ...
                $.ajax({
                    ...
                    if (response.success == false || response.success == 'false') {
                        ...
                        $('#response').html('<div class="alert alert-success">' + response
                            .message + '</div>');
                        $('html,body').animate({
                            scrollTop: $("#<?php echo $form->form_key; ?>").offset()
                                .top
                        }, 'slow');
                    } else {
    ...
    <?php hooks()->do_action('app_estimate_request_form_footer'); ?>
</body>
