...
// Load the CodeIgniter instance to access its functions
$CI = &get_instance();

// Load the sales_helper if not already loaded
$CI->load->helper('sales_helper');
$CI->load->helper('template_helper');

// Call the format_organization_info() function
$company_name = format_organization_info(true);
    ...
    <div class="panel_s">
        <div class="panel-body">
            ...
            <div class="row mtop20">
                <div class="col-md-6" id="expenseHeadings">
                    ...
                    <h4 class="tw-text-sm tw-m-0 tw-text-neutral-500" id="expenserCreator">
                        <?php echo _l('created_by'); ?>: <a href="<?php echo admin_url('staff/profile/' . $expense->addedfrom) ?>">
                            <?php echo get_staff_full_name($expense->addedfrom); ?>
                        </a>
                    </h4>
                </div>

                <!-- Div Class for Payment Voucher -->
                <div class="row mtop100" style="display: none;">
                <div class="col-md-3" id="companyLogo">
                    <?php echo get_company_logo(); ?>
                </div>
                    <div class="col-md-5" id="paymentVoucherHeadings">
                        <div class="row">
                            <div class="col-md-5">
                                <!-- Left side -->
                                <p class="tw-text-sm tw-m-0 tw-text-neutral-500" id="companyName">
                                    <?php echo $company_name; ?>
                                </p>
                                <p class="tw-text-sm tw-m-0 tw-text-neutral-500" id="companyAddress">
                                    <?php echo $organization_info; ?>
                                    <br><br>Tel: <?php echo get_option('invoice_company_phonenumber'); ?> <!-- Display phone number here -->
                                </p>
                            </div>
                            <div class="col-md-4">
                                <!-- Right side -->
                                <div class="text-right">
                                    <h3 class="tw-font-semibold tw-text-lg tw-text-neutral-700 tw-mt-0 tw-mb-1" id="paymentVoucherCategory">
                                        PAYMENT VOUCHER
                                    </h3>
                                    <div class="tw-text-sm tw-m-0 tw-text-neutral-500" id="paymentVoucherId">
                                        PV#: PV0<?php echo $expense->expenseid; ?>-<?php echo $current_year; ?>
                                    </div>
                                    <div class="tw-text-sm tw-m-0 tw-text-neutral-500" id="paymentVoucherDate">
                                        Date: <?php echo _d($expense->date); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <?php if (!empty($expense->expense_customer)) { ?>
                            <h4 class="tw-text-sm tw-m-0 tw-text-neutral-500 tw-font-bold" id="paymentVoucherExpenseCust">
                           <br> <b>Pay To:</b> <?php echo $expense->expense_customer; ?>
                        </h4>
                        <?php } ?>
                        <h4 class="tw-text-sm tw-m-0 tw-text-neutral-500 tw-font-bold" id="paymentVoucherExpenseName">
                           <br> <b>Particular:</b> Payment For <?php echo $expense->expense_name;?>
                        </h4>
                        <h4 class="tw-text-sm tw-m-0 tw-text-neutral-500 tw-font-bold" id="paymentVoucherRefNoCont">
                           <br> <b>Reference:</b> <?php echo $expense->reference_no; ?>
                        </h4>
                        <h4 class="tw-text-sm tw-m-0 tw-text-neutral-500" id="paymentVoucherAmount">
                         Amount<br><?php echo app_format_money($expense->amount, $expense->currency_data); ?>
                        </h4>
                    </div>
                </div>
                ...
                <div class="col-md-6 _buttons text-right">
                    ...
                    <?php } elseif ($expense->invoiceid != null) { ?>
                        <a href="<?php echo admin_url('invoices/list_invoices/' . $expense->invoiceid); ?>" class="btn btn-primary mleft10 pull-right"><?php echo format_invoice_number($invoice->id); ?></a>
                    <?php } ?>
                    <div class="pull-right">
                        <?php if (has_permission('expenses', '', 'edit')) { ?>
                            <a class="btn btn-default btn-with-tooltip" href="<?php echo admin_url('expenses/expense/' . $expense->expenseid); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo _l('expense_edit'); ?>"><i class="fa-regular fa-pen-to-square"></i></a>
                        <?php } ?>
                        <a class="btn btn-default btn-with-tooltip" href="#" onclick="print_expense_information(); return false;" data-toggle="tooltip" data-placement="bottom" title="<?php echo _l('Print Expense'); ?>">
                            <i class="fa fa-print"></i>
                        </a>

                        <!-- Butang Payment Voucher (Duplicate Process Print) -->
                        <a class="btn btn-default btn-with-tooltip" href="#" onclick="print_payment_voucher(); return false;" data-toggle="tooltip" data-placement="bottom" title="<?php echo _l('Payment Voucher'); ?>">
                            <i class="fas fa-file-invoice"></i>
                        </a>

                        <?php if (has_permission('expenses', '', 'create')) { ?>
                            <a class="btn btn-default btn-with-tooltip" href="<?php echo admin_url('expenses/copy/' . $expense->expenseid); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo _l('expense_copy'); ?>"><i class="fa-regular fa-copy"></i></a>
                        <?php } ?>
            ...
            <div class="tab-content">
                ...
                <div class="col-md-6">
                    ...
                    <?php if ($expense->clientid) { ?>
                        ...
                        <p class="mbot15"><a href="<?php echo admin_url('clients/client/' . $expense->clientid); ?>"><?php echo $expense->company; ?></a>
                        </p>
                    <?php } ?>
                    <?php if ($expense->project_id) { ?>
                        <p class="bold mbot5"><?php echo _l('project'); ?></p>
                        <p class="mbot15"><a href="<?php echo admin_url('projects/view/' . $expense->project_id); ?>"><?php echo $expense->project_data->name; ?></a>
                        </p>
                    <?php } ?>
                    <?php
                ...
                <div class="col-md-6" id="expenseReceipt">
                    ...
                    <?php } else { ?>
                        <div class="row">
                            <div class="col-md-10">
                                <i class="<?php echo get_mime_class($expense->filetype); ?>"></i> <a href="<?php echo site_url('download/file/expense/' . $expense->expenseid); ?>">
            ...
            <div role="tabpanel" class="tab-pane" id="tab_reminders">
                <a href="#" data-toggle="modal" class="btn btn-default" data-target=".reminder-modal-expense-<?php echo $expense->id; ?>"><i class="fa-regular fa-bell"></i>
