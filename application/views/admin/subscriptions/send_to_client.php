...
<div class="modal fade email-template" data-editor-id=".<?php echo 'tinymce-' . $subscription->id; ?>"
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <hr />
                        <?php echo render_textarea('email_template_custom', '', $template->message, [], [], '', 'tinymce-' . $subscription->id); ?>
