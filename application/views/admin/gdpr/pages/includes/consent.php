  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <?php echo render_textarea('description', 'Description', $value, ['placeholder' => 'Briefly describe the purpose of this consent. Eq. for what the data will be used.', 'rows' => 10]); ?>
     </div>
