...
<div class="section-statement">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <select class="selectpicker" name="range" id="range" data-width="100%"
                        ...
                        <option value='<?php echo $period_today; ?>' <?php if ($period_selected == $period_today) {
    echo ' selected';
} ?>>
                            <?php echo _l('today'); ?>
                        </option>
                        <option value='<?php echo $period_this_week; ?>' <?php if ($period_selected == $period_this_week) {
    echo ' selected';
} ?>>
                            <?php echo _l('this_week'); ?>
                        </option>
                        <option value='<?php echo $period_this_month; ?>' <?php if ($period_selected == $period_this_month) {
    echo ' selected';
} ?>>
                            <?php echo _l('this_month'); ?>
                        </option>
                        <option value='<?php echo $period_last_month; ?>' <?php if ($period_selected == $period_last_month) {
    echo ' selected';
} ?>>
                            <?php echo _l('last_month'); ?>
                        </option>
                        <option value='<?php echo $period_this_year; ?>' <?php if ($period_selected == $period_this_year) {
    echo ' selected';
} ?>>
                            <?php echo _l('this_year'); ?>
                        </option>
                        <option value='<?php echo $period_last_year; ?>' <?php if ($period_selected == $period_last_year) {
    echo ' selected';
} ?>>
    ...
    echo ' hide';
                        ...
                        <?php echo render_date_input('period-from', '', ($custom_period ? $from : ''), ['onchange' => 'render_customer_statement();']); ?>
                    </div>
                    <div class="col-md-12 period<?php if (!$custom_period) {
    echo ' hide';
} ?>">
                        <?php echo render_date_input('period-to', '', ($custom_period ? $to : ''), ['onchange' => 'render_customer_statement();']); ?>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                <div class="text-right _buttons pull-right">
                    <a href="<?php echo site_url('clients/statement_pdf?from=' . urlencode($from) . '&to=' . urlencode($to) . '&print=true'); ?>"
                        id="statement_print" target="_blank" class="btn btn-default btn-with-tooltip mright5"
                        data-toggle="tooltip" title="<?php echo _l('print'); ?>" data-placement="bottom">
                        <i class="fa fa-print"></i>
                    </a>
                    <a href="<?php echo site_url('clients/statement_pdf?from=' . urlencode($from) . '&to=' . urlencode($to)); ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="text-right">
                                    ...
                                    <p class="text-muted"><?php echo _l('statement_from_to', [$from, $to]); ?></p>
                                    <hr />
                                    <table class="table statement-account-summary">
                                        <tbody>
                                            <tr>
                                                <td class="text-left"><?php echo _l('statement_beginning_balance'); ?>:
                                                </td>
                                                <td><?php echo app_format_money($statement['beginning_balance'], $statement['currency']); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="text-left"><?php echo _l('invoiced_amount'); ?>:</td>
                                                <td><?php echo app_format_money($statement['invoiced_amount'], $statement['currency']); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="text-left"><?php echo _l('amount_paid'); ?>:</td>
                                                <td><?php echo app_format_money($statement['amount_paid'], $statement['currency']); ?>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td><?php echo app_format_money($statement['balance_due'], $statement['currency']); ?>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
                            ...
                            <div class="col-md-12">
                                <div class="text-center bold">
                                    <p class="mbot20"><?php echo _l('customer_statement_info', [$from, $to]); ?></p>
                                </div>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-right">
                                                    <b><?php echo _l('statement_heading_amount'); ?></b>
                                                </th>
                                                <th class="text-right">
                                                    <b><?php echo _l('statement_heading_payments'); ?></b></b>
                                                </th>
                                                <th class="text-right">
                                                    <b><?php echo _l('statement_heading_balance'); ?></b></b>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <?php echo app_format_money($statement['beginning_balance'], $statement['currency'], true); ?>
                                                </td>
                                                <td></td>
                                                <td class="text-right">
                                                    <?php echo app_format_money($statement['beginning_balance'], $statement['currency'], true); ?>
