...
<div class="modal fade email-template" data-editor-id=".<?php echo 'tinymce-' . $client->userid; ?>"
    id="statement_send_to_client" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <?php echo form_open('', ['id' => 'send_statement_form']); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <hr />
                        <?php echo render_textarea('email_template_custom', '', $template->message, [], [], '', 'tinymce-' . $client->userid); ?>
