...
<div class="row">
    <div class="col-md-12">
        ...
        <h4
            class="tw-mt-0 tw-font-semibold tw-text-lg tw-text-neutral-700 section-text section-heading-company-profile">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group company-profile-address-group">
                            ...
                            <textarea name="address" id="address" class="form-control"
                                rows="4"><?php echo clear_textarea_breaks($client->address); ?></textarea>
                        </div>
                    ...
                    <div class="col-md-12 custom-fields">
                        <?php echo render_custom_fields('customers', $client->userid, ['show_on_client_portal' => 1]); ?>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <h4 class="mbot15 mtop20 company-profile-billing-address-heading">
                            <?php echo _l('billing_address'); ?></h4>
                        <div class="form-group company-profile-billing-street-group">
                            ...
                            <textarea name="billing_street" id="billing_street" class="form-control"
                                rows="4"><?php echo clear_textarea_breaks($client->billing_street); ?></textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <h4 class="mbot15 mtop20 company-profile-shipping-address-heading">
                            <?php echo _l('shipping_address'); ?></h4>
                        <div class="form-group company-profile-shipping-street-group">
                            ...
                            <textarea name="shipping_street" id="shipping_street" class="form-control"
                                rows="4"><?php echo clear_textarea_breaks($client->shipping_street); ?></textarea>
                        </div>
