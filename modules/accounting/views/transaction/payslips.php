...
<a href="#" data-toggle="modal" data-target="#payslips_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-payslips"><?php echo _l('bulk_actions'); ?></a>
<table class="table table-payslips">
  <thead>
    <th><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="payslips"><label></label></div></th>
...
<div class="modal fade bulk_actions" id="payslips_bulk_actions" tabindex="-1" role="dialog" data-table=".table-payslips">
