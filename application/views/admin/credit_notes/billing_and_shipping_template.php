                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group no-mbot">
                            <div class="checkbox checkbox-primary checkbox-inline">
                                <input type="checkbox" id="include_shipping" name="include_shipping" <?php if (isset($credit_note) && $credit_note->include_shipping == 1) {
    echo 'checked';
} ?>>
                                <label for="include_shipping"><?php echo _l('shipping_address'); ?></label>
                            </div>
                        </div>
                        <div id="shipping_details" class="<?php if ((isset($credit_note) && $credit_note->include_shipping != 1) || !isset($credit_note)) {
    echo 'hide';
} ?>">
                          <div class="form-group">
                            <div class="checkbox checkbox-primary checkbox-inline">
                                <input type="checkbox" id="show_shipping_on_credit_note" name="show_shipping_on_credit_note" <?php if ((isset($credit_note) && $credit_note->show_shipping_on_credit_note == 1) || !isset($credit_note)) {
    echo 'checked';
} ?>>
