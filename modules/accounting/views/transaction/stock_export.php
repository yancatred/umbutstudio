...
<a href="#" data-toggle="modal" data-target="#stock_export_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-stock-export"><?php echo _l('bulk_actions'); ?></a>
<table class="table table-stock-export">
  <thead>
    <th><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="stock-export"><label></label></div></th>
    <th><?php echo _l('goods_delivery_code'); ?></th>
...
<div class="modal fade bulk_actions" id="stock_export_bulk_actions" tabindex="-1" role="dialog" data-table=".table-stock-export">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
          <?php echo form_hidden('bulk_actions_type', 'stock_export'); ?>
