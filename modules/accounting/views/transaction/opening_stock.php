...
<a href="#" data-toggle="modal" data-target="#opening_stock_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-opening-stock"><?php echo _l('bulk_actions'); ?></a>
<table class="table table-opening-stock">
  <thead>
    <th><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="opening-stock"><label></label></div></th>
    <th><?php echo _l('commodity_code'); ?></th>
    <th><?php echo _l('commodity_name'); ?></th>
    <th><?php echo _l('sku_code'); ?></th>
    <th><?php echo _l('opening_stock'); ?></th>
...
<div class="modal fade bulk_actions" id="opening_stock_bulk_actions" tabindex="-1" role="dialog" data-table=".table-opening-stock">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
          <?php echo form_hidden('bulk_actions_type', 'opening_stock'); ?>
