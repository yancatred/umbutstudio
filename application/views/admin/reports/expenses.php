        ...
        <div class="row">
            <div class="col-md-12">
                <div class="pull-right">
                    <a href="<?php echo admin_url('reports/expenses/detailed_report'); ?>" class="btn btn-success">
                    ...
                    <div class="panel-body">
                        <div class="checkbox checkbox-primary">
                            <input type="checkbox" name="exclude_billable" onchange="filter_expenses();"
                                id="exclude_billable" <?php if ($this->input->get('exclude_billable')) {
                            echo 'checked';
                        }; ?>>
                                ...
                                <tbody>
                                    ...
                                    <tr class="tw-bg-neutral-50">
                                        ...
                                        <?php
                                                    ...
                                                    for ($m = 1; $m <= 12; $m++) {
                                                        echo '<td class="bold">';
                                                        $taxMonth     = isset($taxTotal[$m]) ? $taxTotal[$m] : [];
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="text-muted mbot20"><?php echo _l('not_billable_expenses_by_categories'); ?>
                                </p>
                            </div>
                            <div class="col-md-6">
