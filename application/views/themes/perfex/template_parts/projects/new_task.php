...
<div class="row">
    <div class="col-md-12 mtop10">
        ...
        <h2 class="tw-text-xl tw-font-semibold tw-mt-0"><?php echo _l('new_task'); ?></h2>
    ...
    echo 12;
                ...
                <div class="form-group">
                    ...
                    <select name="priority" class="selectpicker" id="priority" data-width="100%"
                        ...
                        <option value="1" <?php if (get_option('default_task_priority') == 1) {
    echo 'selected';
} ?>><?php echo _l('task_priority_low'); ?></option>
                        <option value="2" <?php if (get_option('default_task_priority') == 2) {
    echo 'selected';
} ?>><?php echo _l('task_priority_medium'); ?></option>
                        <option value="3" <?php if (get_option('default_task_priority') == 3) {
    echo 'selected';
} ?>><?php echo _l('task_priority_high'); ?></option>
                        <option value="4" <?php if (get_option('default_task_priority') == 4) {
    echo 'selected';
        ...
        <div class="row">
            <div class="col-md-6">
                <?php echo render_date_input('startdate', 'task_add_edit_start_date', _d(date('Y-m-d')), ['required' => true]); ?>
            </div>
            <div class="col-md-6">
                <?php echo render_date_input('duedate', 'task_add_edit_due_date', '', $project->deadline ? ['data-date-end-date' => $project->deadline] : []); ?>
            </div>
        </div>
    ...
    echo ' selected';
        ...
        <?php echo render_custom_fields('tasks', '', ['show_on_client_portal' => 1]); ?>
