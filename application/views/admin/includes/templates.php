    ...
    echo 'mtop15';
        ...
        <div class="media-body">
            ...
            <button class="btn pull-right btn-danger"
                onclick="delete_template(this,'<?php echo $rel_type ?>',<?php echo $template['id']; ?>, <?php echo $rel_id ?>);return false;"><i
                    class="fa fa fa-times"></i></button>
            <button class="btn pull-right btn-primary mright5 "
                onclick="edit_template('<?php echo $rel_type ?>',<?php echo $template['id']; ?>, <?php echo $rel_id ?>);return false;"><i
                    class="fa-regular fa-pen-to-square"></i></button>
            <?php } ?>
            <button class="btn pull-right btn-default mright5"
                onclick="insert_template(this,'<?php echo $rel_type ?>',<?php echo $template['id']; ?>);return false;"><?php echo _l('insert_template') ?></button>
