 ...
 * @return mixed             string
 */
function get_company_logo($uri = '', $href_class = '', $type = '', $width = 150)
{
    ...
    if ($company_logo != '') {
        ...
        <img src="' . base_url('uploads/company/' . $company_logo) . '" class="img-responsive" style="width:' . $width . 'px; height:auto; object-fit: contain;" alt="' . html_escape($company_name) . '">
        </a>';
    } elseif ($company_name != '') {
