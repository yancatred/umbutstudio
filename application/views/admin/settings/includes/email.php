    ...
    <div role="tabpanel" class="tab-pane active" id="email_config">
        ...
        <div class="alert alert-warning">
            ...
            <p>
                If you are using your Google Account password to connect to SMTP, it's highly recommended to <span
                    class="bold">update your password with an App Password</span> or use <span class="bold">Google OAuth2</span> to avoid any email sending
        ...
        <div class="form-group">
            ...
            <div
                ...
                <input type="radio" name="settings[email_protocol]" id="microsoft" value="microsoft" <?php if (get_option('email_protocol') == 'microsoft') {
            echo 'checked';
        } ?>>
            ...
            <div
                ...
                <input type="radio" name="settings[email_protocol]" id="google" value="google" <?php if (get_option('email_protocol') == 'google') {
            echo 'checked';
        } ?>>
