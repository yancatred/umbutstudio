        ...
        <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
            ...
            <li role="presentation">
                <a href="#set_tickets_piping" aria-controls="set_tickets_piping" role="tab"
                    data-toggle="tab"><?php echo _l('tickets_piping'); ?></a>
            </li>
            <li role="presentation">
                <a href="#ticket_form" aria-controls="ticket_form" role="tab"
                    data-toggle="tab"><?php echo _l('ticket_form'); ?></a>
            </li>
        </ul>
    </div>
</div>
<div class="tab-content mtop15">
    ...
    <div role="tabpanel" class="tab-pane" id="set_tickets_piping">
        ...
        <code><?php echo hooks()->apply_filters('cpanel_tickets_forwarder_path', FCPATH . 'pipe.php'); ?></code>
        <hr />
        ...
        <hr />
        <?php echo render_select('settings[email_piping_default_priority]', $ticket_priorities, ['priorityid', 'name'], 'email_piping_default_priority', get_option('email_piping_default_priority')); ?>
    </div>
    <div role="tabpanel" class="tab-pane" id="ticket_form">
        ...
        <p><b>Form file location:</b>
            <code><?php echo hooks()->apply_filters('ticket_form_file_location_settings', VIEWPATH . 'forms/ticket.php'); ?></code>
        </p>
        <hr />
        <h4 class="bold font-medium">Embed form</h4>
        <p><?php echo _l('form_integration_code_help'); ?></p>
        <textarea class="form-control"
            rows="2"><iframe width="600" height="850" src="<?php echo site_url('forms/ticket'); ?>" frameborder="0" allowfullscreen></iframe></textarea>
        ...
        <p>
            <span class="label label-default">
                <a href="<?php echo site_url('forms/ticket?col=col-md-8+col-md-offset-2'); ?>"
                    target="_blank"><?php echo site_url('forms/ticket?col=col-md-8+col-md-offset-2'); ?></a>
            </span>
        </p>
        <p>
            <span class="label label-default">
        ...
        <p>
            <span class="label label-default">
                <a href="<?php echo site_url('forms/ticket?language=english'); ?>" target="_blank">
                    <?php echo site_url('forms/ticket?language=english'); ?>
                </a>
            </span>
    </div>