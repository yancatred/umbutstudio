...
<div id="wrapper">
    ...
    if (!empty($subscription->stripe_subscription_id)
        ...
        ?>
                        ...
                        <a href="<?php echo site_url('subscription/' . $subscription->hash); ?>" class="btn btn-default"
                            target="_blank">
            ...
            if (!empty($subscription->stripe_subscription_id) && $subscription->status != 'canceled' && $subscription->status != 'incomplete_expired' && empty($subscription->ends_at)) { ?>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a
                                        href="<?php echo admin_url('subscriptions/cancel/' . $subscription->id . '?type=immediately'); ?>">
                                        <?php echo _l('cancel_immediately'); ?></a></li>
                                <li><a
                                        href="<?php echo admin_url('subscriptions/cancel/' . $subscription->id . '?type=at_period_end'); ?>">
                            ...
                            <div role="tabpanel" class="tab-pane active tw-py-2" id="upcoming_invoice">
                                ...
                                <div class="alert alert-success mtop15">
                                    <a href="https://stripe.com/docs/subscriptions/canceling-pausing#invoices-and-invoice-items"
                                        target="_blank"><i class="fa fa-link"></i></a> After canceling a subscription, a
