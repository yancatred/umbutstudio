...
<div id="wrapper">
    <div class="content">
        <div class="row">
            <div class="col-md-12">
             <p class="text-info inline-block" data-placement="bottom" data-toggle="tooltip" data-title="<?php echo _l('leads_report_converted_notice'); ?>"><i class="fa-regular fa-circle-question"></i></p>
             <div class="panel_s">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-left">
                            <button type="submit" class="btn btn-primary label-margin"><?php echo _l('generate'); ?></button>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                    <hr />
