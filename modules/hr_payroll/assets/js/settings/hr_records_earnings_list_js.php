<script>
	...
	var row_global;
	var hotElement1 = document.getElementById('earnings_list_hr_records_hs');
...
$('.add_earnings_list_hr_records').on('click', function() {
	'use strict';
	
	var valid_contract = $('#earnings_list_hr_records_hs').find('.htInvalid').html();
