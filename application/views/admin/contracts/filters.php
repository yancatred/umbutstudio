...
<div class="_filters _hidden_inputs hidden">
    ...
    echo form_hidden('signed');
    echo form_hidden('marked_signed');
    echo form_hidden('not_expired');
    ?>
</div>
<div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip"
    ...
    <ul class="dropdown-menu dropdown-menu-left width300 height500">
        ...
        <li>
            <a href="#" data-cview="signed"
                onclick="dt_custom_view('signed','.table-contracts','signed'); return false;">
                <?php echo _l('contracts_view_signed'); ?>
            </a>
        </li>
        <li>
            <a href="#" data-cview="marked_signed"
                onclick="dt_custom_view('marked_signed','.table-contracts','marked_signed'); return false;">
                <?php echo _l('contracts_view_marked_as_signed'); ?>
            </a>
        </li>
        <li class="filter-group" data-filter-group="date trash">
            <a href="#" data-cview="not_expired"
                onclick="dt_custom_view('not_expired','.table-contracts','not_expired'); return false;">
                <?php echo _l('contracts_view_not_expired'); ?>
            </a>
        </li>
