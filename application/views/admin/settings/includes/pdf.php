        ...
        <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
            <li role="presentation" class="active">
                <a href="#general" aria-controls="general" role="tab"
                    data-toggle="tab"><?php echo _l('settings_group_general'); ?></a>
            </li>
            <li role="presentation">
                <a href="#signature" aria-controls="general" role="tab"
                    data-toggle="tab"><?php echo _l('signature'); ?></a>
            </li>
            <li role="presentation">
                <a href="#formats" aria-controls="invoice" role="tab"
                    data-toggle="tab"><?php echo _l('pdf_formats'); ?></a>
            </li>
        </ul>
    </div>
</div>
<div class="tab-content mtop15">
    ...
    <div role="tabpanel" class="tab-pane active" id="general">
        ...
        <select name="settings[pdf_font]" class="selectpicker" data-width="100%" data-live-search="true"
        ...
        <hr />
        <?php echo render_input('settings[custom_pdf_logo_image_url]', 'settings_custom_pdf_logo_image_url', get_option('custom_pdf_logo_image_url'), 'text', ['data-toggle' => 'tooltip', 'title' => 'settings_custom_pdf_logo_image_url_tooltip']); ?>
        <hr />
    ...
    <div role="tabpanel" class="tab-pane" id="signature">
        ...
        <hr />
        <?php render_yes_no_option('show_pdf_signature_proposal', 'show_pdf_signature_proposal'); ?>
        <hr />
    ...
    <div role="tabpanel" class="tab-pane" id="formats">
        ...
        <select name="settings[pdf_format_invoice]" id="pdf_format_invoice" class="selectpicker" data-width="100%">
            <option value="A4-PORTRAIT" <?php if (get_option('pdf_format_invoice') == 'A4-PORTRAIT') {
                echo 'selected';
            }?>>A4 <?php echo _l('format_a4_portrait_size'); ?></option>
            <option value="A4-LANDSCAPE" <?php if (get_option('pdf_format_invoice') == 'A4-LANDSCAPE') {
                echo 'selected';
            }?>><?php echo _l('format_letter_size'); ?></option>
            <option value="LETTER-PORTRAIT" <?php if (get_option('pdf_format_invoice') == 'LETTER-PORTRAIT') {
                echo 'selected';
            }?>><?php echo _l('format_letter_portrait'); ?></option>
            <option value="LETTER-LANDSCAPE" <?php if (get_option('pdf_format_invoice') == 'LETTER-LANDSCAPE') {
                echo 'selected';
            }?>><?php echo _l('format_letter_landscape'); ?></option>
        ...
        <select name="settings[pdf_format_estimate]" id="pdf_format_estimate" class="selectpicker" data-width="100%">
            <option value="A4-PORTRAIT" <?php if (get_option('pdf_format_estimate') == 'A4-PORTRAIT') {
                echo 'selected';
            }?>>A4 <?php echo _l('format_a4_portrait_size'); ?></option>
            <option value="A4-LANDSCAPE" <?php if (get_option('pdf_format_estimate') == 'A4-LANDSCAPE') {
                echo 'selected';
            }?>><?php echo _l('format_letter_size'); ?></option>

            <option value="LETTER-PORTRAIT" <?php if (get_option('pdf_format_estimate') == 'LETTER-PORTRAIT') {
                echo 'selected';
            }?>><?php echo _l('format_letter_portrait'); ?></option>
            <option value="LETTER-LANDSCAPE" <?php if (get_option('pdf_format_estimate') == 'LETTER-LANDSCAPE') {
                echo 'selected';
            }?>><?php echo _l('format_letter_landscape'); ?></option>
        ...
        <select name="settings[pdf_format_proposal]" id="pdf_format_proposal" class="selectpicker" data-width="100%">
            <option value="A4-PORTRAIT" <?php if (get_option('pdf_format_proposal') == 'A4-PORTRAIT') {
                echo 'selected';
            }?>>A4 <?php echo _l('format_a4_portrait_size'); ?></option>
            <option value="A4-LANDSCAPE" <?php if (get_option('pdf_format_proposal') == 'A4-LANDSCAPE') {
                echo 'selected';
            }?>><?php echo _l('format_letter_size'); ?></option>

            <option value="LETTER-PORTRAIT" <?php if (get_option('pdf_format_proposal') == 'LETTER-PORTRAIT') {
                echo 'selected';
            }?>><?php echo _l('format_letter_portrait'); ?></option>
            <option value="LETTER-LANDSCAPE" <?php if (get_option('pdf_format_proposal') == 'LETTER-LANDSCAPE') {
                echo 'selected';
            }?>><?php echo _l('format_letter_landscape'); ?></option>
        ...
        <select name="settings[pdf_format_payment]" id="pdf_format_payment" class="selectpicker" data-width="100%">
            <option value="A4-PORTRAIT" <?php if (get_option('pdf_format_payment') == 'A4-PORTRAIT') {
                echo 'selected';
            }?>>A4 <?php echo _l('format_a4_portrait_size'); ?></option>
            <option value="A4-LANDSCAPE" <?php if (get_option('pdf_format_payment') == 'A4-LANDSCAPE') {
                echo 'selected';
            }?>><?php echo _l('format_letter_size'); ?></option>
            <option value="LETTER-PORTRAIT" <?php if (get_option('pdf_format_payment') == 'LETTER-PORTRAIT') {
                echo 'selected';
            }?>><?php echo _l('format_letter_portrait'); ?></option>
            <option value="LETTER-LANDSCAPE" <?php if (get_option('pdf_format_payment') == 'LETTER-LANDSCAPE') {
                echo 'selected';
            }?>><?php echo _l('format_letter_landscape'); ?></option>
        </select>
        <hr />
        <label for="pdf_format_credit_note" class="control-label"><?php echo _l('credit_note'); ?></label>
        <select name="settings[pdf_format_credit_note]" id="pdf_format_credit_note" class="selectpicker"
            data-width="100%">
            <option value="A4-PORTRAIT" <?php if (get_option('pdf_format_credit_note') == 'A4-PORTRAIT') {
                echo 'selected';
            }?>>A4 <?php echo _l('format_a4_portrait_size'); ?></option>
            <option value="A4-LANDSCAPE" <?php if (get_option('pdf_format_credit_note') == 'A4-LANDSCAPE') {
                echo 'selected';
            }?>><?php echo _l('format_letter_size'); ?></option>
            <option value="LETTER-PORTRAIT" <?php if (get_option('pdf_format_credit_note') == 'LETTER-PORTRAIT') {
                echo 'selected';
            }?>><?php echo _l('format_letter_portrait'); ?></option>
            <option value="LETTER-LANDSCAPE" <?php if (get_option('pdf_format_credit_note') == 'LETTER-LANDSCAPE') {
                echo 'selected';
            }?>><?php echo _l('format_letter_landscape'); ?></option>
        </select>
        <hr />
        ...
        <select name="settings[pdf_format_contract]" id="pdf_format_contract" class="selectpicker" data-width="100%">
            <option value="A4-PORTRAIT" <?php if (get_option('pdf_format_contract') == 'A4-PORTRAIT') {
                echo 'selected';
            }?>>A4 <?php echo _l('format_a4_portrait_size'); ?></option>
            <option value="A4-LANDSCAPE" <?php if (get_option('pdf_format_contract') == 'A4-LANDSCAPE') {
                echo 'selected';
            }?>><?php echo _l('format_letter_size'); ?></option>
            <option value="LETTER-PORTRAIT" <?php if (get_option('pdf_format_contract') == 'LETTER-PORTRAIT') {
                echo 'selected';
            }?>><?php echo _l('format_letter_portrait'); ?></option>
            <option value="LETTER-LANDSCAPE" <?php if (get_option('pdf_format_contract') == 'LETTER-LANDSCAPE') {
                echo 'selected';
            }?>><?php echo _l('format_letter_landscape'); ?></option>
        </select>
        <hr />
        ...
        <select name="settings[pdf_format_statement]" id="pdf_format_statement" class="selectpicker" data-width="100%">
            <option value="A4-PORTRAIT" <?php if (get_option('pdf_format_statement') == 'A4-PORTRAIT') {
                echo 'selected';
            }?>>A4 <?php echo _l('format_a4_portrait_size'); ?></option>
            <option value="A4-LANDSCAPE" <?php if (get_option('pdf_format_statement') == 'A4-LANDSCAPE') {
                echo 'selected';
            }?>><?php echo _l('format_letter_size'); ?></option>
            <option value="LETTER-PORTRAIT" <?php if (get_option('pdf_format_statement') == 'LETTER-PORTRAIT') {
                echo 'selected';
            }?>><?php echo _l('format_letter_portrait'); ?></option>
            <option value="LETTER-LANDSCAPE" <?php if (get_option('pdf_format_statement') == 'LETTER-LANDSCAPE') {
                echo 'selected';
            }?>><?php echo _l('format_letter_landscape'); ?></option>
        </select>
