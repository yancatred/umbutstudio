        ...
        <div class="row">
            <div class="col-md-12">
                <div class="_buttons tw-mb-2 sm:tw-mb-4">
                    ...
                    <a href="<?php echo admin_url('knowledge_base/article'); ?>" class="btn btn-primary mright5">
                        <i class="fa-regular fa-plus tw-mr-1"></i>
                        <?php echo _l('kb_article_new_article'); ?>
                    </a>

                    <?php } ?>
                    <?php if ($has_permission_edit || $has_permission_create) { ?>
                    <a href="<?php echo admin_url('knowledge_base/manage_groups'); ?>" class="btn btn-default mright5">
                        <i class="fa-solid fa-layer-group tw-mr-1"></i><?php echo _l('als_kb_groups'); ?>
                    </a>
                                  ...
                                  $articles = $this->db->get()->result_array(); ?>
                                      ...
                                      echo 'line-throught';
                                                                ...
                                                                <div class="panel-body">
                                                                    ...
                                                                    <?php if ($article['staff_article'] == 1) { ?>
                                                                    <span
                                                                        class="label label-default pull-right"><?php echo _l('internal_article'); ?></span>
                                                                    <?php } ?>
                                                                </div>
                                                            </li>
                                                            <?php } ?>
