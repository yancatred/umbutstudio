...
<a href="#" data-toggle="modal" data-target="#stock_import_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-stock-import"><?php echo _l('bulk_actions'); ?></a>
<table class="table table-stock-import">
  <thead>
    <th><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="stock-import"><label></label></div></th>
