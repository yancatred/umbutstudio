...
<div class="tab-content mtop15">
    ...
    <div role="tabpanel" class="tab-pane" id="contracts">
        ...
        <hr />
        <h4 class="no-mbot font-medium"><?php echo _l('contract_sign_reminders'); ?></h4>
        <p><?php echo _l('settings_contract_sign_reminder_every_days_info') ?></p>
        <?php echo render_input('settings[contract_sign_reminder_every_days]', 'contract_sign_reminder_every_days', get_option('contract_sign_reminder_every_days'), 'number'); ?>
    </div>
