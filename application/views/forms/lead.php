    ...
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <?php
    echo render_select('country', get_all_countries(), [ 'country_id', [ 'short_name']], 'lead_country', $lead->country, ['data-none-selected-text' => _l('dropdown_non_selected_tex')]);
    ?>
        ...
        if ($lead->default_language == $availableLanguage) {
            ...
            <div class="col-md-12">
                <?php echo render_textarea('description', 'lead_description', $lead->description, ['rows' => 5]); ?>
            </div>
