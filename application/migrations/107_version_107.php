  ...
  PRIMARY KEY (`id`)
        ...
        foreach ($customers as $customer) {
            foreach ($permissions as $permission) {
                $this->db->insert(db_prefix() . 'customerpermissions', [
