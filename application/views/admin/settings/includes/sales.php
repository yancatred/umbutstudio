        ...
        <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
            <li role="presentation" class="active">
                <a href="#general" aria-controls="general" role="tab"
                    data-toggle="tab"><?php echo _l('settings_sales_heading_general'); ?></a>
            </li>
            <li role="presentation">
                <a href="#invoice" aria-controls="invoice" role="tab"
                    data-toggle="tab"><?php echo _l('invoices'); ?></a>
            </li>
            <li role="presentation">
                <a href="#credit_notes" aria-controls="credit_notes" role="tab"
                    data-toggle="tab"><?php echo _l('credit_notes'); ?></a>
            </li>
            <li role="presentation">
                <a href="#estimates" aria-controls="estimates" role="tab"
                    data-toggle="tab"><?php echo _l('settings_sales_heading_estimates'); ?></a>
            </li>
            <li role="presentation">
...
<div class="tab-content mtop15">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select id="decimal_separator" class="selectpicker" name="settings[decimal_separator]"
                        data-width="100%">
                        <option value="," <?php if (get_option('decimal_separator') == ',') {
    echo ' selected';
}; ?>>,</option>
                        <option value="." <?php if (get_option('decimal_separator') == '.') {
    echo ' selected';
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select id="thousand_separator" class="selectpicker" name="settings[thousand_separator]"
                        data-width="100%" data-show-subtext="true">
                        <option value="," <?php if (get_option('thousand_separator') == ',') {
    echo ' selected';
}; ?>>,</option>
                        <option value="." <?php if (get_option('thousand_separator') == '.') {
    echo ' selected';
}; ?>>.</option>
                        <option value="'" data-subtext="apostrophe" <?php if (get_option('thousand_separator') == "'") {
    echo ' selected';
}; ?>>'</option>
                        <option value="" data-subtext="none" <?php if (get_option('thousand_separator') == '') {
    echo ' selected';
}; ?>>&nbsp;</option>
                        <option value=" " data-subtext="space" <?php if (get_option('thousand_separator') == ' ') {
    echo ' selected';
}; ?>>&nbsp;</option>
                    </select>
                </div>
        ...
        <i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1" data-toggle="tooltip"
            data-title="<?php echo _l('invoices') . ', ' . _l('estimates') . ', ' . _l('proposals') ?>"></i>
      ...
      ?>
        ...
        <p class="text-muted"><?php echo _l('settings_amount_to_words_desc') . '/' . mb_strtolower(_l('proposal')); ?>
        </p>
        <div class="row">
            <div class="col-md-6">
    ...
    <div role="tabpanel" class="tab-pane" id="invoice">
        ...
        <?php echo render_textarea('settings[predefined_clientnote_invoice]', 'settings_predefined_clientnote', get_option('predefined_clientnote_invoice'), ['rows' => 6]); ?>
    ...
    <div role="tabpanel" class="tab-pane" id="credit_notes">
        ...
        <div class="form-group">
            <label for="credit_note_number_format"
                class="control-label clearfix"><?php echo _l('settings_sales_credit_note_number_format'); ?></label>
            <div class="radio radio-primary radio-inline">
                <input type="radio" name="settings[credit_note_number_format]" value="1" id="cn_number_based" <?php if (get_option('credit_note_number_format') == '1') {
          echo 'checked';
      } ?>>
                <label
                    for="cn_number_based"><?php echo _l('settings_sales_invoice_number_format_number_based'); ?></label>
            </div>
            <div class="radio radio-primary radio-inline">
                <input type="radio" name="settings[credit_note_number_format]" value="2" id="cn_year_based" <?php if (get_option('credit_note_number_format') == '2') {
          echo 'checked';
      } ?>>
                <label for="cn_year_based"><?php echo _l('settings_sales_invoice_number_format_year_based'); ?>
                    (YYYY/000001)</label>
            </div>
            <div class="radio radio-primary radio-inline">
                <input type="radio" name="settings[credit_note_number_format]" value="3" id="cn_short_year_based" <?php if (get_option('credit_note_number_format') == '3') {
          echo 'checked';
      } ?>>
                <label for="cn_short_year_based">000001-YY</label>
            </div>
            <div class="radio radio-primary radio-inline">
                <input type="radio" name="settings[credit_note_number_format]" value="4" id="cn_year_month_based" <?php if (get_option('credit_note_number_format') == '4') {
          echo 'checked';
      } ?>>
    ...
    <div role="tabpanel" class="tab-pane" id="estimates">
        ...
        <div class="form-group">
            <label for="estimate_number_format"
                class="control-label clearfix"><?php echo _l('settings_sales_estimate_number_format'); ?></label>
            <div class="radio radio-primary radio-inline">
                <input type="radio" name="settings[estimate_number_format]" value="1" id="e_number_based" <?php if (get_option('estimate_number_format') == '1') {
          echo 'checked';
      } ?>>
                <label
                    for="e_number_based"><?php echo _l('settings_sales_estimate_number_format_number_based'); ?></label>
            </div>
            <div class="radio radio-primary radio-inline">
                <input type="radio" name="settings[estimate_number_format]" value="2" id="e_year_based" <?php if (get_option('estimate_number_format') == '2') {
          echo 'checked';
      } ?>>
                <label for="e_year_based"><?php echo _l('settings_sales_estimate_number_format_year_based'); ?>
                    (YYYY/000001)</label>
            </div>
            <div class="radio radio-primary radio-inline">
                <input type="radio" name="settings[estimate_number_format]" value="3" id="e_short_year_based" <?php if (get_option('estimate_number_format') == '3') {
          echo 'checked';
      } ?>>
                <label for="e_short_year_based">000001-YY</label>
            </div>
            <div class="radio radio-primary radio-inline">
                <input type="radio" name="settings[estimate_number_format]" value="4" id="e_year_month_based" <?php if (get_option('estimate_number_format') == '4') {
          echo 'checked';
      } ?>>
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <select name="settings[default_estimates_pipeline_sort]" id="default_estimates_pipeline_sort"
                    ...
                    <option value="datecreated" <?php if (get_option('default_estimates_pipeline_sort') == 'datecreated') {
          echo 'selected';
      }?>><?php echo _l('estimates_sort_datecreated'); ?></option>
                    <option value="date" <?php if (get_option('default_estimates_pipeline_sort') == 'date') {
          echo 'selected';
      }?>><?php echo _l('estimates_sort_estimate_date'); ?></option>
                    <option value="pipeline_order" <?php if (get_option('default_estimates_pipeline_sort') == 'pipeline_order') {
          echo 'selected';
      }?>><?php echo _l('estimates_sort_pipeline'); ?></option>
                    <option value="expirydate" <?php if (get_option('default_estimates_pipeline_sort') == 'expirydate') {
          echo 'selected';
      }?>><?php echo _l('estimates_sort_expiry_date'); ?></option>
                </select>
            </div>
            <div class="col-md-5">
                <div class="mtop30 text-right">
                    <div class="radio radio-inline radio-primary">
                        <input type="radio" id="k_desc_estimate" name="settings[default_estimates_pipeline_sort_type]"
                            value="asc" <?php if (get_option('default_estimates_pipeline_sort_type') == 'asc') {
          echo 'checked';
      } ?>>
                    ...
                    <div class="radio radio-inline radio-primary">
                        <input type="radio" id="k_asc_estimate" name="settings[default_estimates_pipeline_sort_type]"
                            value="desc" <?php if (get_option('default_estimates_pipeline_sort_type') == 'desc') {
          echo 'checked';
      } ?>>
    ...
    <div role="tabpanel" class="tab-pane" id="proposals">
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <select name="settings[default_proposals_pipeline_sort]" id="default_proposals_pipeline_sort"
                    class="selectpicker" data-width="100%"
                    data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                    <option value="datecreated" <?php if (get_option('default_proposals_pipeline_sort') == 'datecreated') {
          echo 'selected';
      }?>><?php echo _l('proposals_sort_datecreated'); ?></option>
                    <option value="date" <?php if (get_option('default_proposals_pipeline_sort') == 'date') {
          echo 'selected';
      }?>><?php echo _l('proposals_sort_proposal_date'); ?></option>
                    <option value="pipeline_order" <?php if (get_option('default_proposals_pipeline_sort') == 'pipeline_order') {
          echo 'selected';
      }?>><?php echo _l('proposals_sort_pipeline'); ?></option>
                    <option value="open_till" <?php if (get_option('default_proposals_pipeline_sort') == 'open_till') {
          echo 'selected';
      }?>><?php echo _l('proposals_sort_open_till'); ?></option>
                </select>
            </div>
            <div class="col-md-5">
                <div class="mtop30 text-right">
                    <div class="radio radio-inline radio-primary">
                        <input type="radio" id="k_desc_proposal" name="settings[default_proposals_pipeline_sort_type]"
                            value="asc" <?php if (get_option('default_proposals_pipeline_sort_type') == 'asc') {
          echo 'checked';
      } ?>>
                    ...
                    <div class="radio radio-inline radio-primary">
                        <input type="radio" id="k_asc_proposal" name="settings[default_proposals_pipeline_sort_type]"
                            value="desc" <?php if (get_option('default_proposals_pipeline_sort_type') == 'desc') {
          echo 'checked';
      } ?>>
        ...
        <hr />
        <?php echo render_textarea('settings[proposal_info_format]', 'proposal_info_format', clear_textarea_breaks(get_option('proposal_info_format')), ['rows' => 8, 'style' => 'line-height:20px;']); ?>
        <p>
