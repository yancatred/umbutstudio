    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo render_select('share_contacts_id[]', $contacts, ['id', ['firstname', 'lastname']], 'customer_contacts', [get_primary_contact_user_id($client->userid)], ['multiple' => true, 'data-actions-box' => true], [], '', '', false); ?>
            </div>
...
<h4 class="customer-profile-group-heading"><?php echo _l('customer_attachments'); ?></h4>
<p class="text-info"><?php echo _l('customer_files_info_message'); ?></p>
<?php if (isset($client)) { ?>
<?php echo form_open_multipart(admin_url('clients/upload_attachment/' . $client->userid), ['class' => 'dropzone', 'id' => 'client-attachments-upload']); ?>
...
<div class="attachments">
    ...
    if ($type == 'invoice' || $type == 'proposal' || $type == 'estimate' || $type == 'credit_note') {
        ...
        if ($is_image) {
            ...
            echo $attachment_url;
        } ?>" <?php if ($is_image) { ?> data-lightbox="customer-profile" <?php } ?> class="display-block mbot5">
                            <?php if ($is_image) { ?>
            ...
            echo '</div>';
                    ...
                    <td>
                        <div class="onoffswitch" <?php if ($type != 'customer') {?> data-toggle="tooltip"
