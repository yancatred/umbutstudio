...
<a href="#" data-toggle="modal" data-target="#loss_adjustment_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-loss-adjustment"><?php echo _l('bulk_actions'); ?></a>
<table class="table table-loss-adjustment">
  <thead>
    <th><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="loss-adjustment"><label></label></div></th>
...
<div class="modal fade bulk_actions" id="loss_adjustment_bulk_actions" tabindex="-1" role="dialog" data-table=".table-loss-adjustment">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
          <?php echo form_hidden('bulk_actions_type', 'loss_adjustment'); ?>
