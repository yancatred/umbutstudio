                    ...
                    <div class="panel-body">
                        <ul class="nav nav-tabs" role="tablist" id="filters_types">
                            <li role="presentation" class="active"><a href="#sender" aria-controls="sender" role="tab"
                                    data-toggle="tab"><?php echo _l('spam_filter_blocked_senders'); ?></a></li>
                            <li role="presentation"><a href="#subject" aria-controls="subject" role="tab"
                                    data-toggle="tab"><?php echo _l('spam_filter_blocked_subjects'); ?></a></li>
                            <li role="presentation"><a href="#phrase" aria-controls="phrase" role="tab"
                                    data-toggle="tab"><?php echo _l('spam_filter_blocked_phrases'); ?></a></li>
                        </ul>
...
<script>
$(function() {
    initDataTable('.table-sender', '<?php echo admin_url('spam_filters/view/' . $rel_type); ?>/sender', [1], [
        1
    ]);
    initDataTable('.table-subject', '<?php echo admin_url('spam_filters/view/' . $rel_type); ?>/subject', [1], [
        1
    ]);
    initDataTable('.table-phrase', '<?php echo admin_url('spam_filters/view/' . $rel_type); ?>/phrase', [1], [
        1
    ]);
