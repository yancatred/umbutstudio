        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tw-mb-2 sm:tw-mb-4">
                    <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#currency_modal">
                        <i class="fa-regular fa-plus tw-mr-1"></i>
                        <?php echo _l('new_currency'); ?>
                    </a>
                </div>
                <div class="panel_s">
...
<div class="modal fade" id="currency_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open('admin/currencies/manage', ['id' => 'currency_form']); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label
                                        for="decimal_separator"><?php echo _l('settings_sales_decimal_separator'); ?></label>
                                    <select id="decimal_separator" class="selectpicker" name="decimal_separator"
                                        data-width="100%">
                                        <option value=",">,</option>
                                        <option value=".">.</option>
                                    </select>
                        ...
                        <div class="form-group">
                            <label for="placement"
                                class="control-label clearfix"><?php echo _l('settings_sales_currency_placement'); ?></label>
                            <div class="radio radio-primary radio-inline">
                                <input type="radio" name="placement" value="before" id="c_placement_before">
                                <label
                                    for="c_placement_before"><?php echo _l('settings_sales_currency_placement_before'); ?></label>
                            </div>
                            <div class="radio radio-primary radio-inline">
                                <input type="radio" name="placement" id="c_placement_after" value="after">
                                <label
                                    for="c_placement_after"><?php echo _l('settings_sales_currency_placement_after'); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
...
$(function() {
    ...
    $('#currency_modal').on('show.bs.modal', function(event) {
        ...
        $('#currency_modal #decimal_separator').selectpicker('val',
            "<?php echo get_option('decimal_separator'); ?>");
        $('#currency_modal #thousand_separator').selectpicker('val',
            "<?php echo get_option('thousand_separator'); ?>");
        ...
        if (typeof(id) !== 'undefined') {
            ...
            $('#currency_modal #decimal_separator').selectpicker('val', button.data(
                'decimal-separator'));
            $('#currency_modal #thousand_separator').selectpicker('val', button.data(
                'thousand-separator'));
        }
    });
});
