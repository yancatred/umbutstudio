...
class Migration_Version_114 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        foreach ($expenses as $expense) {
            ...
            $this->db->update(db_prefix() . 'expenses', ['currency' => $currency->id]);
        }
