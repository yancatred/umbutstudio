...
<hr />
<h4 class="tw-font-medium tw-mb-4 tw-text-lg"><?php echo _l('after_subscription_payment_succeeded'); ?></h4>
<div class="radio radio-info">
    <input type="radio" id="send_invoice_and_receipt" name="settings[after_subscription_payment_captured]"
...
<div class="radio radio-info">
    <input type="radio" id="send_invoice" name="settings[after_subscription_payment_captured]" value="send_invoice" <?php if (get_option('after_subscription_payment_captured') == 'send_invoice') {
    echo ' checked';
} ?>>
...
<div class="radio radio-info">
    <input type="radio" id="send_payment_receipt" name="settings[after_subscription_payment_captured]"
...
<div class="radio radio-info">
    <input type="radio" id="nothing" name="settings[after_subscription_payment_captured]" value="nothing" <?php if (get_option('after_subscription_payment_captured') == 'nothing') {
    echo ' checked';
} ?>>
