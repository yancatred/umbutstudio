$(window).on("load", function () {
  ...
  "1" == app.options.enable_google_picker && (($.fn.googleDrivePicker.defaults.clientId = app.options.google_client_id), ($.fn.googleDrivePicker.defaults.developerKey = app.options.google_api)),
  (Dropzone.options.newsFeedDropzone = !1),
  (Dropzone.options.salesUpload = !1),
  "Notification" in window && "1" == app.options.desktop_notifications && Notification.requestPermission();
...
function _make_task_checklist_items_deletable() {
  if ("1" == app.options.has_permission_tasks_checklist_items_delete) {
      ...
      $.each(t, function (t, a) {
          var i = $(a);
          0 === $(e[t]).find(".checklist-item-template-remove").length &&
              $(e[t])
                  .find("a > span.text")
                  .after('<small class="checklist-item-template-remove" onclick="remove_checklist_item_template(' + i.attr("value") + '); event.stopPropagation();"><i class="fa fa-remove"></i></small>');
      });
  }
}
  ...
  if (a.length > 0) {
      ...
      a
          ...
          $.each(e, function (e, t) {
              (i = " "),
                  !0 === t.started_timers
                      ? (i += 'disabled class="text-danger" data-subtext="' + app.lang.invoice_task_billable_timers_found + '"')
                      : !1 === t.started_timers && "project" != t.rel_type && (i += 'data-subtext="' + t.rel_name + '"'),
                  a.append('<option value="' + t.id + '"' + i + ">" + t.name + "</option>");
          });
      var n = $(".input-group-addon-bill-tasks-help");
      n.find(".popover-invoker").popover("destroy"), n.empty();
      var s = "";
      (s = empty(t) ? app.lang.invoice_task_item_project_tasks_not_included : app.lang.showing_billable_tasks_from_project + " " + $("#project_id option:selected").text().trim()),
          n.html(
          ...
          delay(function () {
              (n.attr("info-shown-count") < 3 || void 0 === n.attr("info-shown-count")) &&
                  $(".projects-wrapper").is(":visible") &&
                  e.length > 0 &&
                  (n.attr("info-shown-count", void 0 === n.attr("info-shown-count") ? 1 : parseInt(n.attr("info-shown-count")) + 1), n.find(".popover-invoker").click());
          }, 3500);
  }
...
function mainWrapperHeightFix() {
  ...
  setup_menu.css("min-height", $(document).outerHeight(!0) - 126 + "px"),
      $("#menu").css("min-height", $(document).outerHeight(!0) + "px"),
      content_wrapper.css("min-height", $(document).outerHeight(!0) - 63 + "px"),
      t < e && content_wrapper.css("min-height", e + "px"),
      t < e && e < $(window).height() && content_wrapper.css("min-height", $(window).height() - 63 + "px"),
      t > e && t < $(window).height() && content_wrapper.css("min-height", $(window).height() - 63 + "px"),
      is_mobile() && "true" == isRTL && side_bar.css("min-height", $(document).outerHeight(!0) - 63 + "px");
}
function set_body_small() {
  var e = null != navigator.userAgent.match(/iPad/i);
  $(this).width() < 769 || e ? $("body").addClass("page-small") : $("body").removeClass("page-small show-sidebar");
}
...
function delete_option(e, t) {
  confirm_delete() &&
      requestGetJSON("settings/delete_option/" + t).done(function (t) {
...
function init_rel_tasks_table(e, t, a) {
  ...
  if (0 !== i.length) {
      var n,
          s = {},
          o = [0];
      (n = $("body").find("._hidden_inputs._filters._tasks_filters input")),
          $.each(n, function () {
...
function initDataTableInline(e) {
  appDataTableInline(e, { supportsButtons: !0, supportsLoading: !0, autoWidth: !1 });
}
function initDataTable(e, t, a, i, n, s) {
  var o = "string" == typeof e ? $("body").find("table" + e) : e;
  if (0 === o.length) return !1;
  (n = "undefined" == n || void 0 === n ? [] : n), void 0 === s ? (s = [[0, "asc"]]) : 1 === s.length && (s = [s]);
  ...
  (app.options.tables_pagination_limit = parseFloat(app.options.tables_pagination_limit)),
      -1 == $.inArray(app.options.tables_pagination_limit, p) && (p.push(app.options.tables_pagination_limit), _.push(app.options.tables_pagination_limit)),
      p.sort(function (e, t) {
          return e - t;
      }),
      _.sort(function (e, t) {
      ...
      p.push(-1),
      _.push(app.lang.dt_length_menu_all);
  var m = {
          ...
          lengthMenu: [p, _],
          columnDefs: [
              { searchable: !1, targets: a },
              { sortable: !1, targets: i },
          ],
          ...
          initComplete: function (e, t) {
              ...
              s.length && s.attr("colspan", a.find("thead th").length),
                  is_mobile() &&
                      $(window).width() < 400 &&
                      a.find('tbody td:first-child input[type="checkbox"]').length > 0 &&
                      (a.DataTable().column(0).visible(!1, !1).columns.adjust(), $("a[data-target*='bulk_actions']").addClass("hide")),
                  a.parents(".table-loading").removeClass("table-loading"),
                  a.removeClass("dt-table-loading");
          ...
          ajax: {
              ...
              type: "POST",
              data: function (e) {
                  for (var t in (Array.isArray(e.order) &&
                      (e.order = e.order.map(function (e) {
                          var t = o.find("thead th:eq(" + e.column + ")");
                          return t.length > 0 && 1 == t[0].dataset.customField && (e.type = t[0].dataset.type), e;
                      })),
  ...
  return (
      o.is(":hidden") && o.find(".dataTables_empty").attr("colspan", o.find("thead th").length),
      o.on("preXhr.dt", function (e, t, a) {
...
function task_single_update_tags() {
  var e = $("#taskTags");
  $.post(admin_url + "tasks/update_tags", { tags: e.tagit("assignedTags"), task_id: e.attr("data-taskid") });
}
...
function update_todo_items() {
  ...
  $.each(e, function () {
      ...
      0 === e.length
          ? ($(".nav-total-todos").addClass("hide"), $(".unfinished-todos li.no-todos").removeClass("hide"))
          : e.length > 0 && ($(".unfinished-todos li.no-todos").hasClass("hide") || $(".unfinished-todos li.no-todos").addClass("hide"), $(".nav-total-todos").removeClass("hide").html(e.length)),
      (x = 1),
      $.each(t, function () {
  ...
  $.each(e, function () {
      ...
      e.hasClass("line-throught") && e.removeClass("line-throught"),
          $(this).find('input[type="checkbox"]').prop("checked", !1),
          i.push([$(this).find('input[name="todo_id"]').val(), $(this).find('input[name="todo_order"]').val(), $(this).find('input[name="finished"]').val()]);
  }),
      $.each(t, function () {
          var e = $(this).find(".todo-description");
...
function init_datepicker(e, t) {
  appDatepicker({ element_date: e, element_time: t });
}
  ...
  if ("" !== e && void 0 !== e) {
      ...
      if (i.hasClass("filter-group")) {
          ...
          $('[data-filter-group="' + n + '"]')
              .not(i)
              .removeClass("active"),
              $.each($('[data-filter-group="' + n + '"]').not(i), function () {
                  $('input[name="' + $(this).find("a").attr("data-cview") + '"]').val("");
              });
      }
      if (i.not(".dropdown-submenu").hasClass("active")) {
          i.not(".dropdown-submenu").removeClass("active"), i.find("a").blur();
...
function init_roles_permissions(e, t) {
  if (((e = void 0 === e ? $('select[name="role"]').val() : e), !($('.member > input[name="isedit"]').length > 0 && void 0 !== e && void 0 === t) && !0 !== $('input[name="administrator"]').prop("checked") && "" !== e)) {
      ...
      requestGetJSON("staff/role_changed/" + e).done(function (e) {
          a.find(".capability").not('[data-not-applicable="true"]').prop("checked", !1).trigger("change"),
              $.each(a, function () {
                  var t = $(this);
                  $.each(e, function (e, a) {
                      t.data("name") == e &&
...
function toggle_small_view(e, t) {
  if (!is_mobile() && $("#small-table").hasClass("hide") && $(".small-table-right-col").hasClass("col-md-12"))
      return $("#small-table").toggleClass("hide"), $(".small-table-right-col").toggleClass("col-md-12 col-md-7"), void $(window).trigger("resize");
  $("body").toggleClass("small-table");
  var a = $("#small-table");
  if (0 !== a.length) {
      var i = !1;
      a.hasClass("col-md-5")
          ? (a.removeClass("col-md-5").addClass("col-md-12"), (i = !0), $(".toggle-small-view").find("i").removeClass("fa fa-angle-double-right").addClass("fa fa-angle-double-left"))
          : (a.addClass("col-md-5").removeClass("col-md-12"), $(".toggle-small-view").find("i").removeClass("fa fa-angle-double-left").addClass("fa fa-angle-double-right"));
      var n = $(e).DataTable();
      n.columns(hidden_columns).visible(i, !1), n.columns.adjust(), $(t).toggleClass("hide"), $(window).trigger("resize");
  }
}
function logout() {
  if ($(".started-timers-top").find("li.timer").length > 0)
      return (
          system_popup({ message: " ", content: $("#timers-logout-template-warning").html() })
              .find(".popup-message")
              .addClass("hide"),
          !1
      );
...
function elFinderBrowser(e, t, a, i) {
  return (
      tinymce.activeEditor.windowManager.open(
          { file: admin_url + "misc/tinymce_file_browser", title: app.lang.media_files, width: 900, height: 450, resizable: "yes" },
          {
              setUrl: function (t) {
...
function init_editor(e, t) {
  ...
  if (0 !== a.length) {
      ...
      if (("true" == isRTL && (i.directionality = "rtl"), "true" == isRTL && (i.plugins[0] += " directionality"), void 0 !== t)) for (var n in t) "append_plugins" != n ? (i[n] = t[n]) : i.plugins.push(t[n]);
...
function init_btn_with_tooltips() {
  if (is_mobile()) {
      ...
      $.each(t, function () {
          var e = $(this).attr("title");
          void 0 === e && (e = $(this).attr("data-title")),
              void 0 !== e &&
                  ($(this)
                      .find(".btn")
                      .eq(0)
...
function init_form_reminder(e) {
  ...
  $.each(t, function (e, t) {
      $(t).appFormValidator({ rules: { date: "required", staff: "required", description: "required" }, submitHandler: reminderFormHandler });
  });
}
function new_task_reminder(e) {
  var t = $("#newTaskReminderToggle");
  !t.is(":visible") || (t.is(":visible") && null != t.attr("data-edit"))
      ? (t.slideDown(400, function () {
            fix_task_modal_left_col_height();
        }),
        $("#taskReminderFormSubmit").html(app.lang.create_reminder),
        t.find("form").attr("action", admin_url + "tasks/add_reminder/" + e),
        t.find("#description").val(""),
        t.find("#date").val(""),
        t.find("#staff").selectpicker("val", t.find("#staff").attr("data-current-staff")),
        t.find("#notify_by_email").prop("checked", !1),
        null != t.attr("data-edit") && t.removeAttr("data-edit"),
        t.isInViewport() || $("#task-modal").animate({ scrollTop: t.offset().top + "px" }, "fast"))
      : t.slideUp();
}
function edit_reminder(e, t) {
  requestGetJSON("misc/get_reminder/" + e).done(function (t) {
      ...
      0 === a.length && $("body").hasClass("all-reminders")
          ? ((a = $(".reminder-modal--")).find('input[name="rel_type"]').val(t.rel_type), a.find('input[name="rel_id"]').val(t.rel_id))
          : $("#task-modal").is(":visible") &&
            ((a = $("#newTaskReminderToggle")).attr("data-edit") && a.attr("data-edit") == e
                ? (a.slideUp(), a.removeAttr("data-edit"))
                : (a.slideDown(400, function () {
                      fix_task_modal_left_col_height();
                  }),
                  a.attr("data-edit", e),
                  a.isInViewport() || $("#task-modal").animate({ scrollTop: a.offset().top + "px" }, "fast")),
            (i = admin_url + "tasks/edit_reminder/" + e),
            $("#taskReminderFormSubmit").html(app.lang.save)),
          a.find("form").attr("action", i),
          a.find("form").attr("data-edit", !0),
          a.find("#description").val(t.description),
          a.find("#date").val(t.date),
          a.find("#staff").selectpicker("val", t.staff),
          a.find("#notify_by_email").prop("checked", 1 == t.notify_by_email),
          a.hasClass("modal") && a.modal("show");
  });
}
function reminderFormHandler(e) {
  var t = (e = $(e)).serialize();
  return (
      $.post(e.attr("action"), t).done(function (t) {
      ...
      $("body").hasClass("all-reminders") ? $(".reminder-modal--").modal("hide") : $(".reminder-modal-" + e.find('[name="rel_type"]').val() + "-" + e.find('[name="rel_id"]').val()).modal("hide"),
      !1
  );
}
...
function toggle_edit_note(e) {
  $("body")
      .find('[data-note-edit-textarea="' + e + '"]')
      .toggleClass("hide"),
      $("body")
          .find('[data-note-description="' + e + '"]')
          .toggleClass("hide");
}
function edit_note(e) {
  var t = $("body")
      .find('[data-note-edit-textarea="' + e + '"] textarea')
      .val();
  "" !== t &&
      ($.post(admin_url + "misc/edit_note/" + e, { description: t }).done(function (a) {
          (!0 !== (a = JSON.parse(a)).success && "true" != a.success) ||
...
function kanban_load_more(e, t, a, i, n) {
  ...
  if (d <= r) {
      ...
      0 != c.length && "" !== c.val() && ((o.sort_by = c.val()), (o.sort = p)),
          void 0 !== l && "" !== l && (o.search = l),
          ...
          (o.page = d),
          o.page++,
          requestGet(buildUrl(admin_url + a, o))
              .done(function (a) {
                  d++,
                      $('[data-load-status="' + e + '"]').before(a),
                      $('[data-col-status-id="' + e + '"]').attr("data-total", parseInt($('[data-col-status-id="' + e + '"]').attr("data-total")) + $("<ul></ul>").append(a).find("li").length),
                      $(t).attr("data-page", d),
...
function init_kanban(e, t, a, i, n, s) {
  if (0 !== $("#kan-ban").length) {
      ...
      0 != r.length && "" !== r.val() && ((l.sort_by = r.val()), (l.sort = c)), (l.kanban = !0), (e = admin_url + e), (e = buildUrl(e, l));
      var p = $(".kan-ban-col");
      if (p.length > 0) {
          var _ = [];
          p.each(function (e, t) {
              _.push({ status: $(t).data("col-status-id"), total: parseInt($(t).attr("data-total")) });
          }),
              (e +=
                  "&" +
                  _.map(function (e, t) {
                      return "refresh[" + e.status + "]=" + e.total;
                  }).join("&"));
      }
      delay(function () {
          $("body").append('<div class="dt-loader"></div>'),
              $("#kan-ban").load(e, function () {
                  fix_kanban_height(i, n);
                  void 0 !== s && s(),
                      $(".status").sortable({
                          connectWith: a,
                          ...
                          sort: function (e, t) {
                              ...
                              var i = $(a).offset();
                              i.top + a.offsetHeight - e.pageY < 20 ? (a.scrollTop = a.scrollTop + 60) : e.pageY - i.top < 20 && (a.scrollTop = a.scrollTop - 60),
                                  i.left + a.offsetWidth - e.pageX < 20 ? (a.scrollLeft = a.scrollLeft + 60) : e.pageX - i.left < 20 && (a.scrollLeft = a.scrollLeft - 60);
                          },
                          change: function () {
                      ...
                      $(".status").sortable({ cancel: ".not-sortable" });
              });
      }, 200);
  }
}
...
function init_kan_ban_sort_icon(e, t) {
  $("body").find(".kanban-sort-icon").remove(),
      $("body")
          .find("." + t)
          .prepend(" <i class='kanban-sort-icon fa fa-sort-amount-" + e.toLowerCase() + "'></i>");
}
function init_newsfeed_form() {
  "undefined" == typeof newsFeedDropzone &&
      $("body").on("submit", "#new-post-form", function () {
          return (
              $.post(this.action, $(this).serialize()).done(function (e) {
...
function load_post_likes(e) {
  track_load_post_likes <= post_likes_total_pages &&
      ($.post(admin_url + "newsfeed/load_likes_modal", { page: track_load_post_likes, postid: e }).done(function (e) {
...
function load_comment_likes(e) {
  track_load_comment_likes <= comment_likes_total_pages &&
      ($.post(admin_url + "newsfeed/load_comment_likes_model", { page: track_load_comment_likes, commentid: e }).done(function (e) {
...
function load_more_comments(e) {
  ...
  a <= i &&
      ($.post(admin_url + "newsfeed/init_post_comments/" + t, { page: a }).done(function (i) {
          $(e).data("track-load-comments", a), $('[data-comments-postid="' + t + '"] .load-more-comments').before(i);
      }),
      a++,
      $(e).find('input[name="page"]').val(a),
      a >= i - 1 && ($(e).addClass("hide"), $(e).removeClass("display-block")));
}
function newsfeed_new_post(e) {
  var t = {};
  (t.postid = e),
      $.post(admin_url + "newsfeed/load_newsfeed", t).done(function (e) {
...
function add_comment(e) {
  var t = $(e).data("postid");
  $.post(admin_url + "newsfeed/add_comment", { content: $(e).val(), postid: t }).done(function (a) {
      (!0 !== (a = JSON.parse(a)).success && "true" != a.success) ||
          ($(e).val(""),
          $("body").find('[data-comments-postid="' + t + '"] .post-comment').length > 0
              ? $("body")
                    .find('[data-comments-postid="' + t + '"] .post-comment')
                    .prepend(a.comment)
              : refresh_post_comments(t));
  });
}
...
function delete_post(e) {
  confirm_delete() &&
      $.post(
          admin_url + "newsfeed/delete_post/" + e,
          function (t) {
...
function _gen_lead_add_inline_on_select_field(e) {
  var t;
  ($("body").hasClass("leads-email-integration") || $("body").hasClass("web-to-lead-form")) && (e = "lead_" + e),
      (t =
          '<div id="new_lead_' +
          e +
      ...
      $(".form-group-select-input-" + e).after(t),
      $("body")
          .find("#new_" + e + "_name")
          .focus(),
      $('.lead-save-btn,#form_info button[type="submit"],#leads-email-integration button[type="submit"],.btn-import-submit').prop("disabled", !0),
      $(".inline-field-new").addClass("disabled").css("opacity", 0.5),
      $(".form-group-select-input-" + e).addClass("hide");
}
...
function lead_add_inline_select_submit(e) {
  ...
  if ("" !== t) {
      ...
      (i.name = t),
          (i.inline = !0),
          $.post(admin_url + "leads/" + a, i).done(function (a) {
  ...
  $("#new_lead_" + e + "_inline").remove(),
      $(".form-group-select-input-" + e).removeClass("hide"),
      $('.lead-save-btn,#form_info button[type="submit"],#leads-email-integration button[type="submit"],.btn-import-submit').prop("disabled", !1),
...
function validate_lead_form() {
  ...
  $.each(leadUniqueValidationFields, function (a, i) {
      (e[i] = {}),
          ...
          void 0 !== app.lang[i + "_exists"] && (t[i] = { remote: app.lang[i + "_exists"] });
  }),
...
function lead_profile_form_handler(e) {
  ...
  return (
      ...
      $.post(e.attr("action"), t)
          .done(function (e) {
              "" !== (e = JSON.parse(e)).message && alert_float("success", e.message),
                  e.proposal_warning && 0 != e.proposal_warning ? ($("body").find("#lead_proposal_warning").removeClass("hide"), $("body").find("#lead-modal").animate({ scrollTop: 0 }, 800)) : _lead_init_data(e, e.id),
                  $.fn.DataTable.isDataTable(".table-leads") ? table_leads.DataTable().ajax.reload(null, !1) : $("body").hasClass("kan-ban-body") && leads_kanban();
          })
          .fail(function (e) {
...
function update_all_proposal_emails_linked_to_lead(e) {
  $.post(admin_url + "leads/update_all_proposal_emails_linked_to_lead/" + e, { update: !0 }).done(function (t) {
...
function _lead_init_data(e, t) {
  var a = window.location.hash,
      i = $("#lead-modal");
  $("#lead_reminder_modal").html(e.leadView.reminder_data),
      i.find(".data").html(e.leadView.data),
      i.modal({ show: !0, backdrop: "static" }),
      init_tags_inputs(),
      init_selectpicker(),
      init_form_reminder(),
      init_datepicker(),
      ...
      validate_lead_form();
  if (
      (["#tab_lead_profile", "#attachments", "#lead_notes", "#lead_activity", "#gdpr"].indexOf(a) > -1 && (window.location.hash = a),
      ...
      "undefined" != typeof Dropbox &&
          ...
          "undefined" != typeof leadAttachmentsDropzone && leadAttachmentsDropzone.destroy(),
...
function print_lead_information() {
  ...
  e.find("p").css("font-size", "100%").css("font", "inherit").css("vertical-align", "baseline").css("margin", "0px"),
      e.find("h4").css("font-size", "100%"),
      e.find(".lead-field-heading").css("color", "#777").css("margin-bottom", "3px"),
      e.find(".lead-field-heading + p").css("margin-bottom", "15px");
  var a = _create_print_window(t);
  a.document.write("<html><head><title>" + app.lang.lead + "</title>"),
      _add_print_window_default_styles(a),
      a.document.write("<style>"),
      a.document.write(".lead-information-col { float: left; width: 33.33333333%;}"),
      a.document.write("</style>"),
      a.document.write("</head><body>"),
      a.document.write("<h1>" + t + "</h1>"),
      a.document.write('<div id="#leadViewWrapper">' + e.html() + "</div>"),
...
function print_ticket_message(e, t) {
  ...
  n.document.write("<html><head><title>" + app.lang.ticket + "</title>"),
      _add_print_window_default_styles(n),
      n.document.write("</head><body>"),
      n.document.write("<h1>" + i + "</h1>"),
      n.document.write(a),
...
function update_kan_ban_total_when_moving(e, t) {
  if (e.sender && (a = $(e.sender.closest(".kan-ban-col"))).data("status-id") != t) {
      var a,
          i = $('[data-col-status-id="' + t + '"]');
      i.attr("data-total", parseInt(i.attr("data-total")) + 1), (a = $(e.sender.closest(".kan-ban-col"))).attr("data-total", parseInt(a.attr("data-total")) - 1);
  }
}
function init_leads_status_sortable() {
  $("#kan-ban").sortable({
      ...
      update: function (e, t) {
          (data = { order: [] }),
              $.each($(".kan-ban-col"), function (e, t) {
                  data.order.push([$(t).attr("data-col-status-id"), e + 1]);
              }),
...
function leads_kanban(e) {
  init_kanban("leads/kanban", leads_kanban_update, ".leads-status", 290, 360, init_leads_status_sortable);
}
function delete_lead_attachment(e, t, a) {
  confirm_delete() &&
      requestGetJSON("leads/delete_attachment/" + t + "/" + a)
          .done(function (t) {
              (!0 !== t.success && "true" != t.success) || ($(e).parents(".lead-attachment-wrapper").remove(), _lead_init_data(t, t.id));
          })
          .fail(function (e) {
              alert_float("danger", e.responseText);
          });
...
function delete_lead_note(e, t, a) {
  confirm_delete() &&
      requestGetJSON("leads/delete_note/" + t + "/" + a)
          .done(function (t) {
              (!0 !== t.success && "true" != t.success) || ($(e).parents(".lead-note").remove(), _lead_init_data(t, t.id));
          })
          .fail(function (e) {
              alert_float("danger", e.responseText);
          });
...
function lead_mark_as_lost(e) {
  requestGetJSON("leads/mark_as_lost/" + e)
      .done(function (t) {
          (!0 !== t.success && "true" != t.success) ||
              (alert_float("success", t.message),
              $("body")
                  .find("tr#lead_" + e)
                  .remove(),
              $("body")
                  .find('#kan-ban li[data-lead-id="' + e + '"]')
                  .remove()),
...
function lead_unmark_as_lost(e) {
  requestGetJSON("leads/unmark_as_lost/" + e)
      .done(function (e) {
...
function lead_mark_as_junk(e) {
  requestGetJSON("leads/mark_as_junk/" + e)
      .done(function (t) {
          (!0 !== t.success && "true" != t.success) ||
              (alert_float("success", t.message),
              $("body")
...
function lead_unmark_as_junk(e) {
  requestGetJSON("leads/unmark_as_junk/" + e)
      .done(function (e) {
          (!0 !== e.success && "true" != e.success) || alert_float("success", e.message), _lead_init_data(e, e.id);
      })
      .fail(function (e) {
...
function convert_lead_to_customer(e) {
  ...
  t.on(a, function () {
      t.find(".data").html(""),
          requestGet("leads/get_convert_data/" + e)
              .done(function (e) {
                  $("#lead_convert_to_customer").html(e), $("#convert_lead_to_client_modal").modal({ show: !0, backdrop: "static", keyboard: !1 });
              })
              .fail(function (e) {
                  alert_float("danger", e.responseText);
              })
...
function leads_bulk_action(e) {
  if (confirm_delete()) {
      ...
      if (0 == t || void 0 === t) {
          if (
              ((i.lost = $("#leads_bulk_mark_lost").prop("checked")),
              (i.status = $("#move_to_status_leads_bulk").val()),
              (i.assigned = $("#assign_to_leads_bulk").val()),
              (i.source = $("#move_to_source_leads_bulk").val()),
              (i.last_contact = $("#leads_bulk_last_contact").val()),
              (i.tags = $("#tags_bulk").tagit("assignedTags")),
              (i.visibility = $('input[name="leads_bulk_visibility"]:checked').val()),
              (i.assigned = void 0 === i.assigned ? "" : i.assigned),
              (i.visibility = void 0 === i.visibility ? "" : i.visibility),
              "" === i.status && !1 === i.lost && "" === i.assigned && "" === i.source && "" === i.last_contact && 0 == i.tags.length && "" === i.visibility)
          )
              return;
      ...
      $.each(n, function () {
          ...
          $(e).addClass("disabled"),
          setTimeout(function () {
              $.post(admin_url + "leads/bulk_action", i)
                  .done(function () {
...
function init_proposal_editor() {
  ...
  $.each(proposalsTemplates, function (t, a) {
      e.push({ url: admin_url + "proposals/get_template?name=" + a, title: a });
  });
  var t = {
  ...
  is_mobile() &&
      ((t.theme = "modern"),
      (t.mobile = {}),
      (t.mobile.theme = "mobile"),
      (t.mobile.toolbar = _tinymce_mobile_toolbar()),
      (t.inline = !1),
      window.addEventListener("beforeunload", function (e) {
          tinymce.activeEditor.isDirty() && save_proposal_content();
      })),
      e.length > 0 && ((t.templates = e), (t.plugins[3] = "template " + t.plugins[3]), (t.contextmenu = t.contextmenu.replace("inserttable", "inserttable template"))),
      tinymce.init(t);
}
function update_comments_count() {
  var e = $(".comment-item").length;
  $(".total_comments").text(e), 0 === e ? $(".total_comments").addClass("hide") : $(".total_comments").removeClass("hide");
}
function add_proposal_comment() {
  ...
  if ("" != e) {
      var t = {};
      (t.content = e),
          (t.proposalid = proposal_id),
          $("body").append('<div class="dt-loader"></div>'),
          $.post(admin_url + "proposals/add_proposal_comment", t).done(function (e) {
              (e = JSON.parse(e)), $("body").find(".dt-loader").remove(), 1 == e.success && ($("#comment").val(""), get_proposal_comments());
          });
  }
}
function get_proposal_comments() {
  "undefined" != typeof proposal_id &&
      requestGet("proposals/get_proposal_comments/" + proposal_id).done(function (e) {
          $("body").find("#proposal-comments").html(e), update_comments_count("proposal");
      });
}
function remove_proposal_comment(e) {
  confirm_delete() &&
      requestGetJSON("proposals/remove_comment/" + e).done(function (t) {
          1 == t.success && ($('[data-commentid="' + e + '"]').remove(), update_comments_count("proposal"));
      });
}
function edit_proposal_comment(e) {
  var t = $("body")
      .find('[data-proposal-comment-edit-textarea="' + e + '"] textarea')
      .val();
  "" != t &&
      ($.post(admin_url + "proposals/edit_comment/" + e, { content: t }).done(function (a) {
          1 == (a = JSON.parse(a)).success &&
              (alert_float("success", a.message),
              $("body")
                  .find('[data-proposal-comment="' + e + '"]')
                  .html(nl2br(t)));
      }),
...
function toggle_proposal_comment_edit(e) {
  $("body")
      ...
      .toggleClass("hide"),
      $("body")
          .find('[data-proposal-comment-edit-textarea="' + e + '"]')
          .toggleClass("hide");
}
...
function save_proposal_content(e) {
  ...
  (a.proposal_id = proposal_id),
      (a.content = t.getContent()),
      $.post(admin_url + "proposals/save_proposal_data", a)
          .done(function (a) {
...
function sync_proposals_data(e, t) {
  ...
  (a.country = i.find('select[name="country"]').val()),
      (a.zip = i.find('input[name="zip"]').val()),
      (a.state = i.find('input[name="state"]').val()),
      (a.city = i.find('input[name="city"]').val()),
      (a.address = i.find('textarea[name="address"]').val()),
      (a.phone = i.find('input[name="phone"]').val()),
      (a.rel_id = e),
      (a.rel_type = t),
      $.post(admin_url + "proposals/sync_data", a).done(function (e) {
...
function do_task_checklist_items_height(e) {
  void 0 === e && (e = $("body").find("textarea[name='checklist-description']")),
      $.each(e, function () {
          var e = $(this).val();
...
function recalculate_checklist_items_progress() {
  var e = $('input[name="checklist-box"]:checked').length,
      ...
      a = 0,
      i = $(".task-progress-bar");
  if (($(".task-total-checklist-completed").text(e), 0 == t ? ($("body").find(".chk-heading").remove(), $("#task-no-checklist-items").removeClass("hide")) : $("#task-no-checklist-items").addClass("hide"), !(t > 2)))
      return i.parents(".progress").addClass("hide"), e > 0 ? $(".chk-toggle-buttons").removeClass("hide") : $(".chk-toggle-buttons").addClass("hide"), !1;
  i.parents(".progress").removeClass("hide"),
      0 == (a = (100 * e) / t) ? $(".task-progress-bar").addClass("text-dark") : $(".task-progress-bar").removeClass("text-dark"),
      i.css("width", a.toFixed(2) + "%"),
      i.text(a.toFixed(2) + "%"),
      e > 0 ? $(".chk-toggle-buttons").removeClass("hide") : $(".chk-toggle-buttons").addClass("hide"),
      100 == a ? i.removeClass("progress-bar-default").addClass("progress-bar-success") : i.removeClass("progress-bar-success").addClass("progress-bar-default");
}
  ...
  requestGetJSON("tasks/remove_checklist_item_template/" + e).done(function (t) {
      if (!0 === t.success || "true" == t.success) {
          ...
          $.each(n, function (e, t) {
              ...
              a.find('option[value="' + e + '"]').remove(),
              a.selectpicker("refresh"),
              1 === a.find("option").length && (a.selectpicker("destroy"), $(".checklist-templates-wrapper").addClass("hide"));
      }
  });
}
function save_checklist_item_template(e, t) {
  var a = $('.checklist[data-checklist-id="' + e + '"] textarea').val();
  $.post(admin_url + "tasks/save_checklist_item_template", { description: a }).done(function (e) {
...
function add_task_checklist_item(e, t, a) {
  a && $(a).addClass("disabled"), (t = void 0 === t ? "" : t);
  var i = $("#checklist-items").find(".checklist").length;
  $.post(admin_url + "tasks/add_checklist_item", { taskid: e, description: t, list_order: i })
      .done(function () {
...
function update_task_checklist_item(e) {
  ...
  return (
      setTimeout(function () {
          ...
          $.post(admin_url + "tasks/update_checklist_item", { description: a, listid: i }).done(function (n) {
              t.resolve(),
                  !0 === (n = JSON.parse(n)).can_be_template && e.parents(".checklist").find(".save-checklist-template").removeClass("hide"),
                  "" === a &&
                      $("#checklist-items")
                          .find('.checklist[data-checklist-id="' + i + '"]')
                          .remove();
          });
      }, 300),
      t.promise()
...
function init_tasks_checklist_items(e, t) {
  $.post(admin_url + "tasks/init_checklist_items", { taskid: t }).done(function (t) {
      if (($("#checklist-items").html(t), void 0 !== e)) {
          var a = $("#checklist-items").find(".checklist textarea").eq(-1);
          "" === a.val() && a.focus();
      }
...
function _task_attachments_more_and_less_checks() {
  ...
  0 === t.length
      ? e.remove()
      : 2 == t.length && a.hasClass("hide")
      ? $("body").find("#show-more-less-task-attachments-col").remove()
      : 0 !== $(".task_attachments_wrapper .task-attachment-col:visible").length || a.hasClass("hide") || a.click(),
...
function remove_task_attachment(e, t) {
  confirm_delete() &&
      requestGetJSON("tasks/remove_task_attachment/" + t).done(function (e) {
...
function add_task_comment(e) {
  ...
  taskCommentAttachmentDropzone.files.length > 0
      ? taskCommentAttachmentDropzone.processQueue(e)
      : (tinymce.activeEditor ? (t.content = tinyMCE.activeEditor.getContent()) : ((t.content = $("#task_comment").val()), (t.no_editor = !0)),
        (t.taskid = e),
...
function remove_task_comment(e) {
  confirm_delete() &&
      requestGetJSON("tasks/remove_comment/" + e).done(function (t) {
  ...
  (a += "?single_task=" + i),
      ...
      requestGetJSON(a).done(function (a) {
          $("body").find(".dt-loader").remove(),
              (!0 !== a.success && "true" != a.success) ||
                  (reload_tasks_tables(),
                  i && _task_append_html(a.taskHtml),
                  5 == e && "function" == typeof _maybe_remove_task_from_project_milestone && _maybe_remove_task_from_project_milestone(t),
                  0 === $(".tasks-kanban").length && alert_float("success", a.message));
      });
}
function task_change_priority(e, t) {
  ...
  (url += "?single_task=" + a),
      requestGetJSON(url).done(function (e) {
...
function delete_user_unfinished_timesheet(e) {
  confirm_delete() &&
      requestGetJSON("tasks/delete_user_unfinished_timesheet/" + e).done(function (e) {
...
function new_task(e, t) {
  ...
  var n = $("#_task_modal");
  n.is(":visible") && n.modal("hide"),
      requestGet(e)
          .done(function (e) {
              $("#_task").html(e), $("body").find("#_task_modal").modal({ show: !0, backdrop: "static" }), $("#timer-select-task").is(":visible") && ($(".system-popup-close").click(), (window._timer_id = t));
          })
          .fail(function (e) {
              alert_float("danger", e.responseText);
          });
...
function edit_task(e) {
  requestGet("tasks/task/" + e).done(function (e) {
      $("#_task").html(e), $("#task-modal").modal("hide"), $("body").find("#_task_modal").modal({ show: !0, backdrop: "static" });
  });
}
function task_form_handler(e) {
  tinymce.triggerSave(),
      $("#_task_modal").find('input[name="startdate"]').prop("disabled", !1),
      $("#_task_modal").find('button[type="submit"]').prop("disabled", !0),
  ...
  var t = e.action,
      a = new FormData($(e)[0]);
  return (
      $.ajax({ type: $(e).attr("method"), data: a, mimeType: $(e).attr("enctype"), contentType: !1, cache: !1, processData: !1, url: t })
          .done(function (e) {
              if (((!0 !== (e = JSON.parse(e)).success && "true" != e.success) || alert_float("success", e.message), window._timer_id))
                  return (
                      requestGet(admin_url + "/tasks/get_task_by_id/" + e.id).done(function (e) {
...
function system_popup(e) {
  ...
  var t = $("<div/>", { id: "system-popup", class: "system-popup" }).appendTo("body"),
      a = "";
  return (
      (a += '<div class="popup-wrapper fadeIn animated">'),
      (a += '<h2 class="popup-message">'),
      (a += e.message),
      (a += "</h2>"),
      (a += '<div class="popup-content">'),
      (a += e.content),
      (a += '<button type="button" class="system-popup-close"> </button>'),
      (a += "</div>"),
      (a += "</div>"),
      t.html(a).removeClass("hide"),
      $("body").addClass("system-popup"),
      t.find(".system-popup-close").on("click", function () {
          var e = this;
  ...
  if ("" !== t || !n.is(":visible")) {
      if ("" !== a && "0" == t) {
          ...
          return (
              ...
              (s.content += "</select>"),
              "1" == app.options.has_permission_create_task &&
                  ((s.content += '<div class="input-group-addon" style="opacity: 1;">'), (s.content += '<a href="#" onclick="new_task(\'tasks/task\',' + a + '); return false;"><i class="fa fa-plus"></i></a>'), (s.content += "</div>")),
              (s.content += "</div></div>"),
              (s.content += '<div class="form-group">'),
              ...
              (s.content += "</div>"),
              (s.content += "<button type='button' onclick='timer_action(this,document.getElementById(\"timer_add_task_id\").value," + a + ");return false;' class='btn btn-primary'>" + app.lang.confirm + "</button>"),
              (s.message = app.lang.task_stop_timer),
              system_popup(s).attr("id", "timer-select-task"),
              init_ajax_search("tasks", "#timer_add_task_id", void 0, admin_url + "tasks/ajax_search_assign_task_to_timer"),
              !1
          );
      }
      $(e).addClass("disabled");
...
function init_task_modal(e, t) {
  var a = "",
      i = $("#lead-modal"),
      n = $("#_task_modal");
  i.is(":visible") ? ((a += "?opened_from_lead_id=" + i.find('input[name="leadid"]').val()), i.modal("hide")) : null != n.attr("data-lead-id") && (a += "?opened_from_lead_id=" + n.attr("data-lead-id")),
      requestGet("tasks/get_task_data/" + e + a)
          .done(function (e) {
              _task_append_html(e),
                  void 0 !== t &&
                      setTimeout(function () {
...
function task_tracking_stats(e) {
  requestGet("tasks/task_tracking_stats/" + e).done(function (e) {
      $("<div/>", { id: "tracking-stats" }).appendTo("body").html(e), $("#task-tracking-stats-modal").modal("toggle");
  });
}
...
function _init_timers_top_html(e) {
  ...
  e.total_timers > 0 ? t.removeClass("hide").html(e.total_timers) : t.addClass("hide"),
      e.total_timers > 0 ? $("#top-timers").find("svg").addClass("tw-animate-spin") : $("#top-timers").find("svg").removeClass("tw-animate-spin"),
      $("#started-timers-top").html(e.html);
}
...
function save_edited_comment(e, t) {
  ...
  (a.id = e),
      (a.task_id = t),
      (a.content = $('[data-edit-comment="' + e + '"]')
          .find("textarea")
          .val()),
      is_ios() && (a.no_editor = !0),
      $.post(admin_url + "tasks/edit_comment", a).done(function (t) {
...
function fix_task_modal_left_col_height() {
  is_mobile() ||
      $("body")
          ...
          .css("min-height", $("body").find(".task-single-col-right").outerHeight(!0) + "px");
}
function tasks_kanban_update(e, t) {
  if (t === e.item.parent()[0]) {
      var a = $(e.item.parent()[0]).attr("data-task-status-id"),
          i = { order: [], status: a };
      $.each($(e.item.parent()[0]).find("[data-task-id]"), function (e, t) {
          var a = $(t).attr("data-task-id");
          a && i.order.push([a, e + 1]);
      }),
          task_mark_as(a, $(e.item).attr("data-task-id")),
          check_kanban_empty_col("[data-task-id]"),
          setTimeout(function () {
              $.post(admin_url + "tasks/update_order", i).done(function (t) {
                  update_kan_ban_total_when_moving(e, i.status), tasks_kanban();
              });
          }, 200);
  }
}
            ...
            tinymce.init({
                ...
                setup: function (e) {
                    e.on("blur", function (a) {
                        e.isDirty() && $.post(admin_url + "tasks/update_task_description/" + t, { description: e.getContent() }),
                            setTimeout(function () {
...
function tasks_bulk_action(e) {
  if (confirm_delete()) {
      ...
      if (0 == i || void 0 === i) {
          ...
          if (
              ((a.milestone = o.length ? o.selectpicker("val") : ""),
              (a.billable = $("#task_bulk_billable").val()),
              (a.billable = void 0 === a.billable ? "" : a.billable),
              (a.priority = $("#task_bulk_priority").val()),
              (a.priority = void 0 === a.priority ? "" : a.priority),
              "" === a.status && "" === a.priority && "" === a.tags && "" === a.assignees && "" === a.milestone && "" === a.billable)
          )
              return;
...
function load_small_table_item(e, t, a, i, n) {
  ...
  "" === s || window.location.hash ? window.location.hash && !e && (e = window.location.hash.substring(1)) : ((e = s), $('input[name="' + a + '"]').val("")),
      void 0 !== e &&
          "" !== e &&
          (destroy_dynamic_scripts_in_element($(t)),
          $("body").hasClass("small-table") || toggle_small_view(n, t),
          $('input[name="' + a + '"]').val(e),
          do_hash_helper(e),
          $(t).load(admin_url + i + "/" + e),
          $("html, body").animate({ scrollTop: $(t).offset().top + (is_mobile() ? 150 : 0) }, 600));
}
...
function clear_billing_and_shipping_details() {
  for (var e in billingAndShippingFields)
      billingAndShippingFields[e].indexOf("country") > -1
          ? $('select[name="' + billingAndShippingFields[e] + '"]').selectpicker("val", "")
          : ($('input[name="' + billingAndShippingFields[e] + '"]').val(""), $('textarea[name="' + billingAndShippingFields[e] + '"]').val("")),
          "billing_country" == billingAndShippingFields[e] && ($('input[name="include_shipping"]').prop("checked", !1), $('input[name="include_shipping"]').change());
  init_billing_and_shipping_details();
}
function init_billing_and_shipping_details() {
  var e,
      t = $('input[name="include_shipping"]').prop("checked");
  for (var a in billingAndShippingFields)
      (e = ""),
          billingAndShippingFields[a].indexOf("country") > -1
              ? (e = $("#" + billingAndShippingFields[a] + " option:selected").data("subtext"))
              : billingAndShippingFields[a].indexOf("shipping_street") > -1 || billingAndShippingFields[a].indexOf("billing_street") > -1
              ? $('textarea[name="' + billingAndShippingFields[a] + '"]').length &&
                (e = $('textarea[name="' + billingAndShippingFields[a] + '"]')
                    .val()
                    .replace(/(?:\r\n|\r|\n)/g, "<br />"))
              : (e = $('input[name="' + billingAndShippingFields[a] + '"]').val()),
          billingAndShippingFields[a].indexOf("shipping") > -1 && (t || (e = "")),
          void 0 === e && (e = ""),
          (e = "" !== e ? e : "--"),
          $("." + billingAndShippingFields[a]).html(e);
...
function add_item_to_preview(e) {
  requestGetJSON("invoice_items/get_item_by_id/" + e).done(function (e) {
      clear_item_preview_values(),
          $('.main textarea[name="description"]').val(e.description),
          $('.main textarea[name="long_description"]').val(e.long_description.replace(/(<|&lt;)br\s*\/*(>|&gt;)/g, " ")),
          _set_item_preview_custom_fields_array(e.custom_fields),
      ...
      $(document).trigger({ type: "item-added-to-preview", item: e, item_type: "item" });
  });
}
...
function add_task_to_preview_as_item(e) {
  requestGetJSON("tasks/get_billable_task_data/" + e).done(function (t) {
      ...
      var a = $(".main");
      a.find('textarea[name="description"]').val(t.name),
          a.find('textarea[name="long_description"]').val(t.description),
          a.find('input[name="quantity"]').val(t.total_hours),
          a.find('input[name="rate"]').val(t.hourly_rate),
          a.find('input[name="unit"]').val(""),
          $('input[name="task_id"]').val(e),
          $(document).trigger({ type: "item-added-to-preview", item: t, item_type: "task" });
  });
}
function clear_item_preview_values(e) {
  var t = $("table.items tbody").find("tr:last-child").find("select").selectpicker("val"),
      a = $(".main");
  a.find("textarea").val(""),
      a.find('td.custom_field input[type="checkbox"]').prop("checked", !1),
      a.find("td.custom_field input:not(:checkbox):not(:hidden)").val(""),
      a.find("td.custom_field select").selectpicker("val", ""),
...
function add_item_to_table(e, t, a, i) {
  if ("" !== (e = void 0 === e || "undefined" == e ? get_item_preview_values() : e).description || "" !== e.long_description || "" !== e.rate) {
      ...
      (lastAddedItemKey = s), (n += '<tr class="sortable item" data-merge-invoice="' + a + '" data-bill-expense="' + i + '">'), (n += '<td class="dragger">'), isNaN(e.qty) && (e.qty = 1), ("" === e.rate || isNaN(e.rate)) && (e.rate = 0);
      var o = e.rate * e.qty,
      ...
      return (
          get_taxes_dropdown_template(l, e.taxname).done(function (a) {
              (n += '<input type="hidden" class="order" name="newitems[' + s + '][order]">'),
                  ...
                  (n += '<td><textarea name="newitems[' + s + '][long_description]" class="form-control item_long_description" rows="5">' + e.long_description.replace(d, "\n") + "</textarea></td>");
              ...
              l.length > 0 &&
                  $.each(l, function () {
                      ...
                      if (a.is(":checkbox")) {
                          ...
                          $.each(l, function (e, t) {
                              ...
                              $(this).attr("id", a).attr("name", i).next("label").attr("for", a), "1" == $(this).attr("data-custom-field-required") && (r = !0);
                          }),
                              $.each(o, function (t, a) {
                                  e.find('input[value="' + $(a).val() + '"]').attr("checked", !0);
                              }),
                              (t = e.html());
                      } else if (a.is("input") || a.is("textarea"))
                          a.is("input") ? e.find("[data-fieldid]").attr("value", a.val()) : e.find("[data-fieldid]").html(a.val()),
                              e.find("[data-fieldid]").attr("name", i),
                              "1" == e.find("[data-fieldid]").attr("data-custom-field-required") && (r = !0),
                              (t = e.html());
                      else if (a.is("select")) {
                          "1" == $(this).attr("data-custom-field-required") && (r = !0);
                          var d = $(this).find("select[data-fieldid]").selectpicker("val");
                          d = (d = new Array(d))[0].constructor === Array ? d[0] : d;
                          var c = e.find("select"),
                              p = $("<div/>");
                          c.attr("name", i);
                          var _ = c.clone();
                  ...
                  $(document).trigger({ type: "item-added-to-table", data: e, row: n }),
                  setTimeout(function () {
                      calculate_total();
                  }, 15);
              ...
              return (
                  ...
                  r && $(".invoice-form").length
                      ? validate_invoice_form()
                      : r && $(".estimate-form").length
                      ? validate_estimate_form()
                      : r && $(".proposal-form").length
                      ? validate_proposal_form()
                      : r && $(".credit-note-form").length && validate_credit_note_form(),
                  ("undefined" != i && i) ||
...
function get_taxes_dropdown_template(e, t) {
  return $.post(admin_url + "misc/get_taxes_dropdown_template", { name: e, taxname: t });
}
function deselect_ajax_search(e) {
  ...
  t
      ...
      .selectpicker("val", "multiple" == t.attr("multiple") ? [] : ""),
      a.removeClass("ajax-remove-values-option").find(".ajax-clear-values").remove(),
      setTimeout(function () {
...
function save_ei_items_order() {
  ...
  $.each(t, function () {
      ...
      setTimeout(function () {
          $.post(admin_url + "misc/update_ei_items_order/" + i, { data: n });
      }, 200);
}
...
function get_item_preview_values() {
  var e = {};
  return (
      (e.description = $('.main textarea[name="description"]').val()),
      (e.long_description = $('.main textarea[name="long_description"]').val()),
      (e.qty = $('.main input[name="quantity"]').val()),
      (e.taxname = $(".main select.tax").selectpicker("val")),
      (e.rate = $('.main input[name="rate"]').val()),
      (e.unit = $('.main input[name="unit"]').val()),
      e
  );
}
  ...
  $(".tax-area").remove(),
      $.each(p, function () {
          "" === (r = $(this).find("[data-quantity]").val()) && ((r = 1), $(this).find("[data-quantity]").val(1)),
              ...
              (l += n),
              (i = $(this)),
              (a = $(this).find("select.tax").selectpicker("val")) &&
                  $.each(a, function (a, l) {
                      (t = i.find('select.tax [value="' + l + '"]').data("taxrate")),
                          (e = (n / 100) * t),
                          o.hasOwnProperty(l)
                              ? (o[l] = o[l] += e)
                              : 0 != t && ((s = l.split("|")), (tax_row = '<tr class="tax-area"><td>' + s[0] + "(" + t + '%)</td><td id="tax_id_' + slugify(l) + '"></td></tr>'), $(_).after(tax_row), (o[l] = e));
                  });
      }),
      "" !== u && 0 != u && "before_tax" == v && h.hasClass("discount-type-percent") ? (c = (l * u) / 100) : "" !== f && 0 != f && "before_tax" == v && h.hasClass("discount-type-fixed") && (c = f),
      $.each(o, function (e, t) {
          ...
          (d += t), (t = format_money(t)), $("#tax_id_" + slugify(e)).html(t);
      }),
      (d += l),
      "" !== u && 0 != u && "after_tax" == v && h.hasClass("discount-type-percent") ? (c = (d * u) / 100) : "" !== f && 0 != f && "after_tax" == v && h.hasClass("discount-type-fixed") && (c = f),
      (d -= c),
      (m = parseFloat(m)),
      isNaN(m) || (d += m);
  var b = "-" + format_money(c);
  $('input[name="discount_total"]').val(accounting.toFixed(c, app.options.decimal_places)),
      $(".discount-total").html(b),
      $(".adjustment").html(format_money(m)),
      $(".subtotal").html(format_money(l) + hidden_input("subtotal", accounting.toFixed(l, app.options.decimal_places))),
      $(".total").html(format_money(d) + hidden_input("total", accounting.toFixed(d, app.options.decimal_places))),
...
function delete_item(e, t) {
  $(e)
      ...
      t && $('input[name="isedit"]').length > 0 && $("#removed-items").append(hidden_input("removed_items[]", t));
}
function format_money(e, t) {
  return void 0 !== t && t ? accounting.formatMoney(e, { symbol: "" }) : accounting.formatMoney(e);
}
function init_currency(e, t) {
  var a = $("body").find(".accounting-template");
  (a.length || e) &&
      requestGetJSON("misc/get_currency/" + (e || a.find('select[name="currency"]').val())).done(function (e) {
          (accounting.settings.currency.decimal = e.decimal_separator),
              (accounting.settings.currency.thousand = e.thousand_separator),
              (accounting.settings.currency.symbol = e.symbol),
              (accounting.settings.currency.format = "after" == e.placement ? "%v %s" : "%s%v"),
              calculate_total(),
              t && t();
      });
}
function delete_invoice_attachment(e) {
  confirm_delete() &&
      requestGet("invoices/delete_attachment/" + e)
          .done(function (t) {
              1 == t &&
                  ($("body")
                      .find('[data-attachment-id="' + e + '"]')
                      .remove(),
...
function delete_credit_note_attachment(e) {
  confirm_delete() &&
      requestGet("credit_notes/delete_attachment/" + e)
          .done(function (t) {
              1 == t &&
                  ($("body")
                      .find('[data-attachment-id="' + e + '"]')
...
function delete_estimate_attachment(e) {
  confirm_delete() &&
      requestGet("estimates/delete_attachment/" + e)
          .done(function (t) {
              if (1 == t) {
                  $("body")
                      .find('[data-attachment-id="' + e + '"]')
...
function delete_proposal_attachment(e) {
  confirm_delete() &&
      requestGet("proposals/delete_attachment/" + e)
          .done(function (t) {
              if (1 == t) {
                  var a = $("body").find('input[name="_attachment_sale_id"]').val();
                  $("body")
                      .find('[data-attachment-id="' + e + '"]')
                      .remove(),
                      $("body").hasClass("proposals-pipeline") ? proposal_pipeline_open(a) : init_proposal(a);
              }
          })
          .fail(function (e) {
              alert_float("danger", e.responseText);
  ...
  if (0 !== $("#invoices_total").length) {
      ...
      if (!$("body").hasClass("invoices-total-manual") || void 0 !== e || a.hasClass("initialized"))
          if (t.length > 0 && a.hasClass("initialized")) t.removeClass("invoices-total-inline");
              ...
              var s = { currency: $("body").find('select[name="total_currency"]').val(), years: n, init_total: !0 },
                  o = $('input[name="project_id"]').val(),
                  l = $('.customer_profile input[name="userid"]').val();
              void 0 !== o ? (s.project_id = o) : void 0 !== l && (s.customer_id = l),
                  $.post(admin_url + "invoices/get_invoices_total", s).done(function (e) {
...
function init_estimates_total(e) {
  if (0 !== $("#estimates_total").length) {
      ...
      if (!$("body").hasClass("estimates-total-manual") || void 0 !== e || t.hasClass("initialized")) {
          ...
          void 0 !== l ? (s = l) : void 0 !== d && (o = d),
              $.post(admin_url + "estimates/get_estimates_total", { currency: a, init_total: !0, years: n, customer_id: s, project_id: o }).done(function (e) {
...
function init_expenses_total() {
  if (0 !== $("#expenses_total").length) {
      ...
      var s = "",
          o = $('input[name="project_id"]').val();
      void 0 !== s && (s = o),
          $.post(admin_url + "expenses/get_expenses_total", { currency: e, init_total: !0, years: a, customer_id: i, project_id: s }).done(function (e) {
  ...
  (e = void 0 === e ? "#invoice-form" : e),
      ...
      $("body")
          ...
          .rules("add", {
              ...
              messages: { remote: app.lang.invoice_number_exists },
          });
}
function validate_credit_note_form(e) {
  (e = void 0 === e ? "#credit-note-form" : e),
      appValidateForm($(e), {
          clientid: {
              required: {
                  depends: function () {
      ...
      $("body")
          ...
          .rules("add", {
              ...
              messages: { remote: app.lang.credit_note_number_exists },
          });
}
function validate_estimate_form(e) {
  (e = void 0 === e ? "#estimate-form" : e),
      appValidateForm($(e), {
          clientid: {
              required: {
                  depends: function () {
      ...
      $("body")
          ...
          .rules("add", {
              ...
              messages: { remote: app.lang.estimate_number_exists },
          });
}
...
function estimate_pipeline() {
  init_kanban("estimates/get_pipeline", estimates_pipeline_update, ".pipeline-status", 290, 360);
}
function estimates_pipeline_update(e, t) {
  if (t === e.item.parent()[0]) {
      var a = { estimateid: $(e.item).attr("data-estimate-id"), status: $(e.item.parent()[0]).attr("data-status-id"), order: [] };
      $.each($(e.item).parents(".pipeline-status").find("li"), function (e, t) {
          var i = $(t).attr("data-estimate-id");
          i && a.order.push([i, e + 1]);
      }),
          check_kanban_empty_col("[data-estimate-id]"),
          setTimeout(function () {
              $.post(admin_url + "estimates/update_pipeline", a).done(function (t) {
                  update_kan_ban_total_when_moving(e, a.status), estimate_pipeline();
              });
          }, 200);
  }
}
function proposals_pipeline_update(e, t) {
  if (t === e.item.parent()[0]) {
      var a = { order: [], status: $(e.item.parent()[0]).attr("data-status-id"), proposalid: $(e.item).attr("data-proposal-id") };
      $.each($(e.item).parents(".pipeline-status").find("li"), function (e, t) {
          var i = $(t).attr("data-proposal-id");
          i && a.order.push([i, e + 1]);
      }),
          check_kanban_empty_col("[data-proposal-id]"),
          setTimeout(function () {
              $.post(admin_url + "proposals/update_pipeline", a).done(function (t) {
                  update_kan_ban_total_when_moving(e, a.status), proposals_pipeline();
              });
          }, 200);
  }
}
function proposals_pipeline() {
  init_kanban("proposals/get_pipeline", proposals_pipeline_update, ".pipeline-status", 290, 360);
}
function proposal_pipeline_open(e) {
  "" !== e &&
      requestGet("proposals/pipeline_open/" + e).done(function (e) {
          var t = $(".proposal-pipeline-modal:visible").length > 0;
          $("#proposal").html(e), t ? $("#proposal").find(".modal.proposal-pipeline-modal").removeClass("fade").addClass("in").css("display", "block") : $(".proposal-pipeline-modal").modal({ show: !0, backdrop: "static", keyboard: !1 });
      });
}
function estimate_pipeline_open(e) {
  "" !== e &&
      requestGet("estimates/pipeline_open/" + e).done(function (e) {
          var t = $(".estimate-pipeline:visible").length > 0;
          $("#estimate").html(e), t ? $("#estimate").find(".modal.estimate-pipeline").removeClass("fade").addClass("in").css("display", "block") : $(".estimate-pipeline").modal({ show: !0, backdrop: "static", keyboard: !1 });
      });
}
function delete_sales_note(e, t) {
  confirm_delete() &&
      requestGetJSON("misc/delete_note/" + t).done(function (t) {
          if (!0 === t.success || "true" == t.success) {
...
function save_sales_number_settings(e) {
  var t = {};
  (t.prefix = $("body").find('input[name="s_prefix"]').val()),
      $.post($(e).data("url"), t).done(function (e) {
      ...
      $.each(t, function (e, a) {
          if (4 == a.length) {
              ...
              if (i.hasClass("format-n-yy")) a = a.substr(-2);
                  ...
                  var n;
                  "d-m-Y" == app.options.date_format || "d/m/Y" == app.options.date_format || "Y-m-d" == app.options.date_format || "d.m.Y" == app.options.date_format
                      ? (n = 1)
                      : ("m-d-Y" != app.options.date_format && "m.d.Y" != app.options.date_format && "m/d/Y" != app.options.date_format) || (n = 0),
                      $("#prefix_month").html(t[n]);
              }
              i.html(a);
          }
      });
...
function unformat_date(e) {
  var t = _split_formatted_date_by_separator(e),
      ...
      n = 2;
  return (
      "d-m-Y" == app.options.date_format || "d/m/Y" == app.options.date_format || "d.m.Y" == app.options.date_format
          ? ((n = 0), (a = 1), (i = 2))
          : ("m-d-Y" != app.options.date_format && "m.d.Y" != app.options.date_format && "m/d/Y" != app.options.date_format) || ((n = 1), (a = 0), (i = 2)),
      t[i] + "-" + t[a] + "-" + t[n]
  );
}
...
function init_tabs_scrollable() {
  "true" != isRTL
      ? ($(window).width() <= 768 && $("body").find(".toggle_view").remove(), $(".horizontal-scrollable-tabs").horizontalTabs())
      : ($(".arrow-left, .arrow-right").css("display", "none"), $(".horizontal-scrollable-tabs").removeClass("horizontal-scrollable-tabs"), $(".nav-tabs-horizontal").removeClass("nav-tabs-horizontal"));
}
...
function set_notification_read_inline(e) {
  requestGet("misc/set_notification_read_inline/" + e).done(function () {
      ...
      t.find(".notification-handler").removeClass("unread-notification"), t.find(".not-mark-as-read-inline").tooltip("destroy").remove();
  });
}
function mark_all_notifications_as_read_inline() {
  requestGet("misc/mark_all_notifications_as_read_inline/").done(function () {
      ...
      e.find(".notification-handler").removeClass("unread-notification"), e.find(".not-mark-as-read-inline").tooltip("destroy").remove();
  });
}
function delete_sale_activity(e) {
  confirm_delete() &&
      requestGet("misc/delete_sale_activity/" + e).done(function () {
          $("body")
              .find('[data-sale-activity-id="' + e + '"]')
              .remove();
      });
}
function view_event(e) {
  void 0 !== e &&
      $.post(admin_url + "utilities/view_event/" + e).done(function (e) {
          $("#event").html(e), $("#viewEvent").modal("show"), init_datepicker(), init_selectpicker(), validate_calendar_form();
      });
}
function delete_event(e) {
  confirm_delete() &&
      requestGetJSON("utilities/delete_event/" + e).done(function (e) {
          (!0 !== e.success && "true" != e.success) || window.location.reload();
      });
}
function validate_calendar_form() {
  appValidateForm($("body").find("._event form"), { title: "required", start: "required", reminder_before: "required" }, calendar_form_handler),
      appValidateForm($("body").find("#viewEvent form"), { title: "required", start: "required", reminder_before: "required" }, calendar_form_handler);
}
function calendar_form_handler(e) {
  return (
      $.post(e.action, $(e).serialize()).done(function (e) {
          (!0 !== (e = JSON.parse(e)).success && "true" != e.success) ||
...
function init_new_task_comment(e) {
  tinymce.editors.task_comment && tinymce.remove("#task_comment"),
      "undefined" != typeof taskCommentAttachmentDropzone && taskCommentAttachmentDropzone.destroy(),
  ...
  (t.plugins[0] += " mention"),
      (t.content_style = "span.mention {        background-color: #eeeeee;        padding: 3px;    }"),
      (t.setup = function (e) {
          initStickyTinyMceToolbarInModal(e, document.querySelector(".task-modal-single")),
              e.on("init", function () {
                  0 === $("#mention-autocomplete-css").length &&
                      $("<link>")
                          .appendTo("head")
                          .attr({ id: "mention-autocomplete-css", type: "text/css", rel: "stylesheet", href: site_url + "assets/plugins/tinymce/plugins/mention/autocomplete.css" }),
                      0 === $("#mention-css").length &&
                          $("<link>")
                              .appendTo("head")
                              .attr({ type: "text/css", id: "mention-css", rel: "stylesheet", href: site_url + "assets/plugins/tinymce/plugins/mention/rte-content.css" });
              });
      });
  var n = [];
  (t.mentions = {
      source: function (e, t, a) {
          n.length < 1
              ? $.getJSON(admin_url + "tasks/get_staff_names_for_mentions/" + i, function (e) {
                    (n = e), t(e);
                })
              : t(n);
      },
      ...
      var s = {
          ...
          preprocessData: function (e) {
              for (var t = [], a = e.length, i = 0; i < a; i++) {
                  var n = { value: e[i].id, text: e[i].name };
                  e[i].subtext && (n.data = { subtext: e[i].subtext }), t.push(n);
              }
              return t;
          },
...
function merge_field_format_url(e, t, a, i) {
  return e && e.indexOf("%7B") > -1 && e.indexOf("%7D") > -1 && (e = e.replaceAll("%7B", "{").replaceAll("%7D", "}")), e;
}
function salesGoogleDriveSave(e) {
  salesExtenalFileUpload(e, "gdrive");
}
function leadExternalFileUpload(e, t, a) {
  $.post(admin_url + "leads/add_external_attachment", { files: e, lead_id: a, external: t }).done(function () {
      init_lead_modal_data(a);
  });
}
function taskExternalFileUpload(e, t, a) {
  $.post(admin_url + "tasks/add_external_attachment", { files: e, task_id: a, external: t }).done(function () {
      init_task_modal(a);
  });
}
function salesExtenalFileUpload(e, t) {
  var a = {};
  (a.rel_id = $("body").find('input[name="_attachment_sale_id"]').val()),
      (a.type = $("body").find('input[name="_attachment_sale_type"]').val()),
      (a.files = e),
      (a.external = t),
      $.post(admin_url + "misc/add_sales_external_attachment", a).done(function () {
          "estimate" == a.type
              ? $("body").hasClass("estimates-pipeline")
                  ? estimate_pipeline_open(a.rel_id)
                  : init_estimate(a.rel_id)
              : "proposal" == a.type
              ? $("body").hasClass("proposals-pipeline")
                  ? proposal_pipeline_open(a.rel_id)
                  : init_proposal(a.rel_id)
              : "function" == typeof window["init_" + a.type] && window["init_" + a.type](a.rel_id),
              $("#sales_attach_file").modal("hide");
      });
}
function set_search_history(e) {
  for (var t = $("#search-history"), a = "", i = 0; i < e.length; i++)
      a += '<li data-index="' + i + '"><a href="#" class="history">' + e[i] + ' <span class="remove-history pointer pull-right" style="z-index:1500"><i class="fa fa-remove"></i></span></a></li>';
  t.html(a);
}
function requestGet(e, t) {
  t = void 0 === t ? {} : t;
  var a = { type: "GET", url: e.indexOf(admin_url) > -1 ? e : admin_url + e };
  return $.ajax($.extend({}, a, t));
}
function requestGetJSON(e, t) {
  return ((t = void 0 === t ? {} : t).dataType = "json"), requestGet(e, t);
}
function update_templates_count(e) {
  var t = $(".templates-wrapper").length;
  $(".total_templates").text(t), 0 === t ? $(".total_templates").addClass("hide") : $(".total_templates").removeClass("hide");
}
function get_templates(e, t) {
  "proposals" === e
      ? $("#proposal-templates").load(admin_url + "templates", { rel_type: e, rel_id: t }, function () {
            update_templates_count();
        })
      : "contracts" === e &&
        $("#contract-templates").load(admin_url + "templates", { rel_type: e, rel_id: t }, function () {
            update_templates_count();
        });
}
...
function setStickyTinyMceToolbarInModal(e, t) {
  ...
  if (isTinyMceStickyInModal(e) && $(a).isInViewport())
      return $(a).css({ paddingTop: i.outerHeight() }), void i.css({ top: t.scrollTop - 30, bottom: "auto", position: "fixed", width: $(a).width(), zIndex: 1, borderBottom: "1px solid rgba(0,0,0,0.2)" });
  $(a).css({ paddingTop: 0 }), i.css({ position: "relative", width: "auto", borderBottom: "none", top: 0 });
}
function isTinyMceStickyInModal(e) {
  return e.editorContainer.getBoundingClientRect().top < 0;
}
function add_template(e, t) {
  $("#modal-wrapper").load(admin_url + "templates/modal", { slug: "new", rel_type: e, rel_id: t }, function () {
      $("#TemplateModal").is(":hidden") && $("#TemplateModal").modal({ backdrop: "static", show: !0 }),
          appValidateForm($("#template-form"), { name: "required" }),
          ...
          init_editor("#content", {
              ...
              fontsize_formats: "8pt 10pt 12pt 14pt 18pt 24pt 36pt",
              pagebreak_separator: '<p pagebreak="true"></p>',
              contextmenu: "link image inserttable | cell row column deletetable | paste copy | pagebreak",
              append_plugins: "pagebreak",
          });
  });
}
function edit_template(e, t, a) {
  $("#modal-wrapper").load(admin_url + "templates/modal", { slug: "edit", id: t, rel_type: e, rel_id: a }, function () {
      $("#TemplateModal").is(":hidden") && $("#TemplateModal").modal({ backdrop: "static", show: !0 }),
          appValidateForm($("#template-form"), { name: "required" }),
          tinymce.remove("#content"),
          init_editor("#content", {
...
function delete_template(e, t, a) {
  confirm_delete() &&
      $.post(admin_url + "templates/delete/" + a).done(function (a) {
          (!0 !== (a = JSON.parse(a)).success && "true" != a.success) ||
              ("proposals" === t ? $(e).parents(".proposal-templates-wrapper").html("") : "contracts" === t && $(e).parents(".contract-templates-wrapper").html(""), get_templates(t));
      });
}
function insert_template(e, t, a) {
  requestGetJSON(admin_url + "templates/index/" + a).done(function (e) {
      var a = e.data;
      tinymce.activeEditor.execCommand("mceInsertContent", !1, a.content), "proposals" == t ? $('a[aria-controls="tab_proposal"]').click() : "contracts" == t && $('a[aria-controls="tab_content"]').click(), tinymce.activeEditor.focus();
  });
}
      ...
      $.post(e, t)
          .done(function (e) {
              if ((e = JSON.parse(e)).hasOwnProperty("alert_type")) alert_float(e.alert_type, e.message);
                  ...
                  var t = "",
                      i = $("#folder"),
                      n = i.selectpicker("val");
                  e.forEach(function (e) {
                      t += '<option name="' + e + '"' + (e == n ? " selected" : "") + ">" + e + "</option>";
                  }),
                      i.html(t),
                      i.selectpicker("refresh"),
                      n || i.selectpicker("val", i.find("option:eq(0)")[0].value);
              }
              a.resolve(e);
          })
          .fail(function (e) {
...
function add_batch_payment() {
  $("#modal-wrapper").load(admin_url + "payments/batch_payment_modal", function () {
      $("#batch-payment-modal").is(":hidden") && $("#batch-payment-modal").modal({ backdrop: "static", show: !0 }), init_selectpicker(), init_datepicker();
      var e = $("#batch-payment-filter");
      e.on("changed.bs.select", function () {
          "" !== e.val()
              ? $(".batch_payment_item").each(function () {
                    $(this).data("clientid") == e.val() ? ($(this).find("input, select").prop("disabled", !1), $(this).removeClass("hide")) : ($(this).addClass("hide"), $(this).find("input, select").prop("disabled", !0));
                })
              : $(".batch_payment_item").each(function () {
                    $(this).removeClass("hide"), $(this).find("input, select").prop("disabled", !1);
                });
      }),
                          ...
                          required: function () {
                              ...
                              return (
                                  e
                                      ...
                                      .find("input, select")
                                      .filter('select[name$="[paymentmode]"],input[name$="[transactionid]"],input[name$="[amount]"]')
                                      .each(function () {
                                          "" != $(this).val() && (t = !0), $(this).hasClass("selectpicker") && t && (e.prop("required", !0), $(this).selectpicker("refresh"));
                                      }),
                                  t
                              );
                          },
...
function print_expense_information() {
    var e = $("#expenseHeadings").parent().clone(),
        t = _create_print_window("EXPENSE DETAILS");
    t.document.write("<html><head><title>" + app.lang.expense + "</title>"),
        _add_print_window_default_styles(t),
        t.document.write("</head><body>"),
        t.document.write("<h3 class='tw-font-semibold tw-text-lg tw-text-neutral-700 tw-mt-0 tw-mb-1' id='expenseCategory'>");
        t.document.write(e.find("#expenseCategory").html()),
        t.document.write("</h1>");
        t.document.write("<div class='tw-text-sm tw-m-0 tw-text-neutral-500' id='expenseName'></h4>");
        t.document.write(e.find("#expenseName").html()),
        t.document.write("</div>");
...
function print_payment_voucher() {
  var e = $("#paymentVoucherHeadings").parent().clone(),
      t = _create_print_window("PAYMENT VOUCHER");
  t.document.write("<html><head><title>" + app.lang.expense + "</title>"),
      t.document.write(
          "<style>#paymentVoucherCategory { font-size: 20px;}#paymentVoucherId, #paymentVoucherDate { font-size: 16px; }#paymentVoucherAmount { margin-top: 2px; font-weight: bold; }.section-divider { clear: both; margin-top: 10px; border-top: 1px solid #000; }</style>"
      ),
      _add_print_window_default_styles(t),
      t.document.write("</head><body>"),
      t.document.write("<br><br><br>");
      t.document.write("<table style='width: 100%;'><tr>"),
      t.document.write("<td style='width: 20%;'>"),
      t.document.write("<div class='col-md-3' id='companyLogo'>");
      t.document.write(e.find("#companyLogo").html()),
      t.document.write("</div>");
      t.document.write("</td>"),
      t.document.write("<td style='width: 50%;'>"),
      t.document.write("<p class='tw-text-sm tw-m-0 tw-text-neutral-500' id='companyName'>");
      t.document.write(e.find("#companyName").html()),
      t.document.write("</p>");
      t.document.write("<p class='tw-text-sm tw-m-0 tw-text-neutral-500' id='companyAddress'>"),
      t.document.write(e.find("#companyAddress").html()),
      t.document.write("</p>"),
      t.document.write("</td>"),
      t.document.write("<td style='width: 30%; text-align: left;'>"),
      t.document.write("<h3 class='tw-font-semibold tw-text-lg tw-text-neutral-700 tw-mt-0 tw-mb-1' id='paymentVoucherCategory'>PAYMENT VOUCHER</h3>"),
      t.document.write("<div class='text-left'>"),
      t.document.write("<div class='tw-text-sm tw-m-0 tw-text-neutral-500' id='paymentVoucherId'>"),
      t.document.write(e.find("#paymentVoucherId").html()),
      t.document.write("</div>"),
      t.document.write("<div class='tw-text-sm tw-m-0 tw-text-neutral-500' id='paymentVoucherDate'>"),
      t.document.write(e.find("#paymentVoucherDate").html()),
      t.document.write("</div>"),
      t.document.write("</div>"),
      t.document.write("</td>"),
      t.document.write("</tr></table>"),
      t.document.write("<hr class='section-divider'>"),
      t.document.write("<table style='width: 100%;'><tr>"),
      t.document.write("<td style='width: 70%;'>"),
      t.document.write("<div class='tw-text-sm tw-m-0 tw-text-neutral-500' id='paymentVoucherExpenseCust'>");
      t.document.write(e.find("#paymentVoucherExpenseCust").html());
      t.document.write("</div>");
      t.document.write("<div class='tw-text-sm tw-m-0 tw-text-neutral-500' id='paymentVoucherExpenseName' style='margin-bottom: 3px;'>");
      t.document.write(e.find("#paymentVoucherExpenseName").html());
      t.document.write("</div>");
      t.document.write("<div class='tw-text-sm tw-m-0 tw-text-neutral-500' id='paymentVoucherRefNoCont'>");
      t.document.write(e.find("#paymentVoucherRefNoCont").html());
      t.document.write("</div>");
      t.document.write("<td style='width: 5%;'>"),
      t.document.write("<div class='tw-text-sm tw-m-0 tw-text-neutral-500' id='paymentVoucherAmount' style='text-align: left;'>"),
      t.document.write(e.find("#paymentVoucherAmount").html()),
      t.document.write("</div>"),
      t.document.write("</td>"),
      t.document.write("</tr></table>"),
      t.document.write("<br>");
      t.document.write("<br>");
      t.document.write("<p>");
      t.document.write("Generated automatically. No signature is required.");
      t.document.write("</p>");
      t.document.write("</body></html>"),
      t.document.close(),
      t.focus(),
...
$("body").on("loaded.bs.select change", "select.ajax-search", function (e) {
  ...
  if ((!Array.isArray(t) || 0 != t.length) && t && !$(this).is(":disabled")) {
      ...
      if (0 === a.find(".ajax-clear-values").length) {
          var i = $(this).attr("id");
          a.addClass("ajax-remove-values-option")
              .find("button.dropdown-toggle")
              .after('<span class="pointer ajax-clear-values" onclick="deselect_ajax_search(this); return false;" data-id="' + i + '"></span>');
      }
  }
}),
  ...
  $(window).on("load resize", function (e) {
      $("body").hasClass("page-small") || set_body_small(),
          setTimeout(
              function () {
  ...
  $(document).on("mousemove", function (e) {
      !is_mobile() && $("body").hasClass("hide-sidebar") && (("true" == isRTL && $(window).width() - e.pageX <= 10) || ("false" == isRTL && e.pageX <= 10)) && $(".hide-menu").click();
  }),
  $(function () {
      var e, t;
      totalUnreadNotifications > 0 && (document.title = "(" + totalUnreadNotifications + ") " + doc_initial_title),
          $(".screen-options-btn").on("click", function () {
              $(".screen-options-area").slideToggle();
          }),
          $("body").hasClass("has-deprecated-errors") &&
              ((e = $("div:contains('A PHP Error was encountered')")),
              (t = 0),
              $.each(e, function () {
          ...
          add_hotkey("Shift+E", function () {
              var e = $("#lead-modal"),
                  t = $("#task-modal");
              e.is(":visible") || t.is(":visible")
                  ? e.is(":visible")
                      ? $("a[lead-edit]").click()
                      : t.is(":visible") && edit_task(t.find("[data-task-single-id]").attr("data-task-single-id"))
          ...
          add_hotkey("Shift+T", function () {
              ...
              e.length > 0
                  ? new_task(admin_url + "tasks/task?rel_id=" + e.attr("data-rel-id") + "&rel_type=" + e.attr("data-rel-type"))
          ...
          1 != app.options.show_setup_menu_item_only_on_hover ||
              is_mobile() ||
              side_bar.hover(
                  function () {
                      setTimeout(function () {
      ...
      tab_active && a.find('[href="#' + tab_active + '"]').click(),
          tab_group &&
              (a.find("li").not('[role="presentation"]').removeClass("active"),
              a
          ...
          init_color_pickers(),
          initDataTableInline(),
          $("body").on("change", ".onoffswitch input", function (e, t) {
          ...
          init_progress_bars(),
          init_datepicker(),
          $(document).on("app.form-validate", function (e, t) {
              if (!0 === select_picker_validated_event) return !0;
              (select_picker_validated_event = !0),
                  $(t).on("change", "select.ajax-search, select.selectpicker", function (e) {
      ...
      if (
          (i.length && (i.parents("li").not(".quick-links").addClass("active"), i.prop("aria-expanded", !0), i.parents("ul.nav-second-level").prop("aria-expanded", !0), i.parents("li").find("a:first-child").prop("aria-expanded", !0)),
          setup_menu.hasClass("display-block"))
      ) {
      ...
      side_bar.metisMenu(),
          ...
          $(".hide-menu").click(function (e) {
              e.preventDefault(),
                  $("body").hasClass("hide-sidebar") ? $("body").removeClass("hide-sidebar").addClass("show-sidebar") : $("body").removeClass("show-sidebar").addClass("hide-sidebar"),
                  setup_menu.hasClass("display-block") && $(".close-customizer").click();
          }),
          is_mobile() &&
          ...
          $("#search_input").on("click focus", function () {
              if ("" == $(this).val()) {
                  ...
                  e.find("li").length > 0 && (e.css("width", $(this).outerWidth() + "px"), e.addClass("display-block"));
              }
          }),
          ...
          $("#search_input").on("keyup paste" + ("safari" == app.browser ? " input" : ""), function () {
              ...
              (t.length < 2 && -1 === app.user_language.indexOf("chinese") && -1 === app.user_language.indexOf("japanese")) ||
                  (i.html('<i class="fa fa-remove"></i>').addClass("search_remove"),
                  delay(function () {
                      t != original_top_search_val &&
                          $.post(admin_url + "misc/search", { q: t }).done(function (e) {
      ...
      if (
          (s && $("#search_input").val(s).trigger("keyup"),
          ...
          $("body").on("click", ".timesheet-toggle-enter-type", function (e) {
              ...
              $(this).find("span").not(t).removeClass("hide").addClass("switch-to"),
          ...
          $("body").on("hidden.bs.modal", ".modal-reminder", function (e) {
              ...
              t.find("form").attr("action", admin_url + "misc/add_reminder/" + a + "/" + i),
                  t.find("form").removeAttr("data-edit"),
                  t.find(":input:not([type=hidden]), textarea").val(""),
                  t.find('input[type="checkbox"]').prop("checked", !1),
                  t.find("select").selectpicker("val", "");
          }),
          ...
          $("body").on("click", ".delete-reminder", function () {
              return (
                  confirm_delete() &&
                      requestGetJSON($(this).attr("href")).done(function (e) {
          ...
          $("body").on("keypress", 'textarea[name="checklist-description"]', function (e) {
              if ("13" == e.which) {
                  var t = $(this);
                  return (
                      update_task_checklist_item(t).done(function () {
          ...
          $("body").on("change", ".task-single-inline-field", function () {
              ...
              $.each(e, function () {
                  ...
                  "startdate" == e && "" === a ? i.addClass("text-danger") : "startdate" == e && "" !== a && i.removeClass("text-danger"),
                      (("startdate" == e && "" !== a) || "startdate" != e) && ((t[$(this).attr("name")] = a), "startdate" != e && "" === a ? i.css("opacity", 0.5) : i.css("opacity", 1));
              });
          ...
          $("[data-can-view-own], [data-can-view]").on("change", function () {
              ...
              (view_chk_selector = $(this)
                  .parents("tr")
                  .find("td input[" + (void 0 !== e && !1 !== e ? "data-can-view" : "data-can-view-own") + "]")),
                  1 != view_chk_selector.data("not-applicable") && (view_chk_selector.prop("checked", !1), view_chk_selector.prop("disabled", !0 === $(this).prop("checked")));
          }),
          "undefined" != typeof taskid && "" !== taskid && init_task_modal(taskid),
          $("body").on("change", 'input[name="checklist-box"]', function () {
              requestGet(admin_url + "tasks/checkbox_action/" + $(this).parents(".checklist").data("checklist-id") + "/" + (!0 === $(this).prop("checked") ? 1 : 0)),
                  recalculate_checklist_items_progress(),
                  $(this).prop("checked") && $('button[data-hide="1"]').hasClass("hide") && $(this).closest(".checklist ").addClass("hide");
          }),
          ...
          $("#task-modal").on("change", 'input[name="timesheet_start_time"], input[name="timesheet_end_time"], input[name="timesheet_duration"]', function () {
              $(this).val() && $(this).parents(".form-group").hasClass("has-error") && $(this).parents(".form-group").removeClass("has-error");
          }),
          $("body").on("click", ".task-single-add-timesheet", function (e) {
              e.preventDefault();
              var t = $("body").find('#task-modal input[name="timesheet_start_time"]'),
                  a = $("body").find('#task-modal input[name="timesheet_end_time"]'),
                  i = $("body").find('#task-modal input[name="timesheet_duration"]'),
                  n = t.val(),
                  s = a.val(),
                  o = i.val();
              if (("" === n && t.parents(".form-group").addClass("has-error"), "" === s && a.parents(".form-group").addClass("has-error"), "" === o && i.parents(".form-group").addClass("has-error"), ("" !== n && "" !== s) || "" !== o)) {
                  var l = {};
                  (l.timesheet_duration = o),
                      (l.start_time = n),
                      (l.end_time = s),
                      (l.timesheet_task_id = $(this).data("task-id")),
                      (l.note = $("body").find("#task_single_timesheet_note").val()),
                      (l.timesheet_staff_id = $("body").find('#task-modal select[name="single_timesheet_staff_id"]').val()),
                      $.post(admin_url + "tasks/log_time", l).done(function (e) {
                          !0 === (e = JSON.parse(e)).success || "true" == e.success
                              ? (init_task_modal(l.timesheet_task_id),
                                alert_float("success", e.message),
                                setTimeout(function () {
                                    reload_tasks_tables();
                                }, 20))
                              : alert_float("warning", e.message);
                      });
              }
          }),
          $("body").on("click", ".copy_task_action", function () {
              ...
              return (
                  ...
                  (e.copy_from = $(this).data("task-copy-from")),
                  (e.copy_task_assignees = $("body").find("#copy_task_assignees").prop("checked")),
                  (e.copy_task_followers = $("body").find("#copy_task_followers").prop("checked")),
                  (e.copy_task_checklist_items = $("body").find("#copy_task_checklist_items").prop("checked")),
                  (e.copy_task_attachments = $("body").find("#copy_task_attachments").prop("checked")),
                  (e.copy_task_status = $("body").find('input[name="copy_task_status"]:checked').val()),
                  $.post(admin_url + "tasks/copy", e).done(function (e) {
          ...
          $("body").on("shown.bs.modal", "#_task_modal", function (e) {
              $(e.currentTarget).hasClass("edit") ? "" !== $(this).find(".tinymce-task").val().trim() && init_editor(".tinymce-task", { height: 200 }) : $("body").find("#_task_modal #name").focus(), init_tags_inputs();
          }),
          $("body").on("hidden.bs.modal", "#_task_modal", function () {
              tinyMCE.remove(".tinymce-task"),
                  "undefined" != typeof _ticket_message && (_ticket_message = void 0),
                  null == $(this).attr("data-lead-id") || $(this).attr("data-task-created") || init_lead($(this).attr("data-lead-id")),
          ...
          $("body").on("hide.bs.modal", "#task-modal", function (e) {
              tinymce.editors.forEach(function (t) {
                  t.id.includes("task_comment") && "" !== t.getContent() && $(t.editorContainer).is(":visible") && e.preventDefault();
              });
          }),
          $("body").on("hide.bs.modal", "#task-modal", function (e) {
              var t = $("#task-modal");
              if ((t.find(".timesheet-edit").is(":visible") && e.preventDefault(), t.find(".add-timesheet").is(":visible"))) {
                  var a = t.find("#timesheet_start_time").val(),
                      i = t.find("#timesheet_end_time").val(),
                      n = t.find("#timesheet_duration").val(),
                      s = t.find("#task_single_timesheet_note").val();
          ...
          $("body").on("change", 'select[name="select-assignees"]', function () {
              $("body").append('<div class="dt-loader"></div>');
              var e = {};
              (e.assignee = $('select[name="select-assignees"]').val()),
                  "" !== e.assignee &&
                      ((e.taskid = $(this).attr("data-task-id")),
                      $.post(admin_url + "tasks/add_task_assignees", e).done(function (e) {
          ...
          $("body").on("change", 'select[name="select-followers"]', function () {
              var e = {};
              (e.follower = $('select[name="select-followers"]').val()),
                  "" !== e.follower &&
                      ((e.taskid = $(this).attr("data-task-id")),
                      $("body").append('<div class="dt-loader"></div>'),
                      $.post(admin_url + "tasks/add_task_followers", e).done(function (e) {
          ...
          $("body").on("show.bs.modal", "#task-tracking-stats-modal", function () {
              ...
              setTimeout(function () {
                  "undefined" != typeof taskTrackingChart && taskTrackingChart.destroy(),
                      (taskTrackingChart = new Chart(e, {
                          type: "line",
          ...
          $("body").on("shown.bs.modal", "#sync_data_proposal_data", function () {
              "lead" == $("#sync_data_proposal_data").data("rel-type") &&
                  $("#lead-modal .data")
                      .eq(0)
                      .css("height", $("#sync_data_proposal_data .modal-content").height() + 80 + "px")
          ...
          "undefined" != typeof openLeadID && "" !== openLeadID && init_lead(openLeadID, !!get_url_param("edit")),
          $("body").on("click", ".leads-kan-ban .cpicker", function () {
              var e = $(this).data("color"),
                  t = $(this).parents(".panel-heading").data("status-id");
              $.post(admin_url + "leads/change_status_color", { color: e, status_id: t });
          }),
          ...
          var o = {
                  ...
                  function (e, t, a) {
                      ...
                      return (
                          $("#calendar_filters")
                              ...
                              .get(),
                          jQuery.isEmptyObject(i) || (i.calendar_filters = !0),
                          $.getJSON(admin_url + "utilities/get_calendar_data", $.extend({}, i, { start: e.startStr, end: e.endStr })).then(function (e) {
                              t(
                                  e.map(function (e) {
                                      return $.extend({}, e, { start: e.start || e.date, end: e.end || e.date });
                                  })
                              );
                          })
                      );
              ...
              eventDidMount: function (e) {
                  var t = $(e.el);
                  t.attr("title", e.event.extendedProps._tooltip),
                      t.attr("onclick", e.event.extendedProps.onclick),
                      t.attr("data-toggle", "tooltip"),
                      e.event.extendedProps.url ||
                          t.on("click", function () {
                              view_event(e.event.extendedProps.eventid);
                          });
              },
              dateClick: function (e) {
                  e.dateStr.length <= 10 && (e.dateStr += "T00:00:00");
          ...
          if (
              ($("body").hasClass("dashboard") &&
                  ...
                  (o.headerToolbar.left += ",viewFullCalendar")),
              (o.customButtons.calendarFilter = {
                  text: app.lang.filter_by.toLowerCase(),
                  click: function () {
                      slideToggle("#calendar_filters");
                  },
              }),
              (o.headerToolbar.right += ",calendarFilter"),
              1 == app.user_is_staff_member && ("" !== app.options.google_api && (o.googleCalendarApiKey = app.options.google_api), "" !== app.calendarIDs && ((app.calendarIDs = JSON.parse(app.calendarIDs)), 0 != app.calendarIDs.length)))
          )
      ...
      $("body").on("change", 'select[name="tax"]', function () {
          ...
          $("body").on("change blur", ".apply-credits-to-invoice .apply-credits-field", function () {
              ...
              $.each(t, function () {
                  ...
                  e.find("#credits-alert").remove(),
                  e.find(".amount-to-credit").html(format_money(a)),
                  i < a
                      ? ($(".credits-table").before($("<div/>", { id: "credits-alert", class: "alert alert-danger" }).html(app.lang.credit_amount_bigger_then_credit_note_remaining_credits)), e.find('[type="submit"]').prop("disabled", !0))
                      : (e.find(".credit-note-balance-due").html(format_money(i - a)), e.find('[type="submit"]').prop("disabled", !1));
          }),
          $("body").on("change blur", ".apply-credits-from-invoice .apply-credits-field", function () {
              ...
              $.each(t, function () {
                  ...
                  e.find(".amount-to-credit").html(format_money(a)),
                  a > i
                      ? ($(".credits-table").before($("<div/>", { id: "credits-alert", class: "alert alert-danger" }).html(app.lang.credit_amount_bigger_then_invoice_balance)), e.find('[type="submit"]').prop("disabled", !0))
                      : (e.find(".invoice-balance-due").html(format_money(i - a)), e.find('[type="submit"]').prop("disabled", !1));
          }),
          ...
          $("body").on("shown.bs.modal", "#lead-modal", function (e) {
              custom_fields_hyperlink(),
                  0 === $("body").find('#lead-modal input[name="leadid"]').length && $("body").find('#lead-modal input[name="name"]').focus(),
                  init_tabs_scrollable(),
                  $("body").find(".lead-wrapper").hasClass("open-edit") && $("body").find("a[lead-edit]").click();
          }),
          $("body").on("show.bs.modal", "#lead-modal", function (e) {
              0 == $("#lead-more-dropdown").find("li").length && $("#lead-more-btn").css("display", "none").css("pointer-events", "none");
          }),
          $("#lead-modal").on("hidden.bs.modal", function (e) {
              destroy_dynamic_scripts_in_element($(this)),
                  $(this).data("bs.modal", null),
                  $("#lead_reminder_modal").html(""),
                  $("#lead-modal").is(":visible") || history.pushState("", document.title, window.location.pathname + window.location.search),
          ...
          $("body").on("submit", "#lead-modal .consent-form", function () {
              ...
              return (
                  $.post($(this).attr("action"), e).done(function (e) {
          ...
          $("body").on("click", '#lead-modal a[data-toggle="tab"]', function () {
              "#tab_lead_profile" == this.hash || "#attachments" == this.hash || "#lead_notes" == this.hash || "#gdpr" == this.hash || "#lead_activity" == this.hash
          ...
          $("body").on("click", "#lead_enter_activity", function () {
              ...
              "" !== e &&
                  $.post(admin_url + "leads/add_activity", { leadid: t, activity: e })
                      .done(function (e) {
      ...
      var c = { custom_view: "[name='custom_view']", assigned: "[name='view_assigned']", status: "[name='view_status[]']", source: "[name='view_source']" };
      if ((table_leads = $("table.table-leads")).length) {
          var p = table_leads.find("#th-consent"),
              _ = [0],
              m = [0, table_leads.find("#th-assigned").index()];
          p.length > 0 && (_.push(p.index()), m.push(p.index())),
              (_table_api = initDataTable(table_leads, admin_url + "leads/table", m, _, c, [table_leads.find("th.date-created").index(), "desc"])),
              _table_api &&
                  p.length > 0 &&
              ...
              $.each(c, function (e, t) {
                  $("select" + t).on("change", function () {
                      $("[name='view_status[]']")
                          .prop("disabled", "lost" == $(this).val() || "junk" == $(this).val())
      ...
      if (
          ...
          $("form").not("#single-ticket-form,#calendar-event-form,#proposal-form, #department-form").areYouSure(),
          ...
          $(".bulk_actions").on("change", 'input[name="mass_delete"]', function () {
              var e = $("#bulk_change");
              !0 === $(this).prop("checked")
                  ? (e.find("select").selectpicker("val", ""), e.addClass("hide"), $(".mass_delete_separator, merge_tickets_checkbox").addClass("hide"), $("#merge_tickets").prop("checked", !1))
                  : (e.removeClass("hide"), $(".mass_delete_separator, merge_tickets_checkbox").removeClass("hide"));
          }),
          $("body").on("change loaded.bs.select", "#item_select", function () {
              var e = $(".items-wrapper .items-select-wrapper");
              $(".items-wrapper .bootstrap-select").css("max-width", e.width() + "px"), $(".items-wrapper .bootstrap-select").css("width", "100%");
          }),
          $(".send-test-sms").on("click", function () {
              ...
              t.empty(),
                  "" != (a = a.trim()) &&
                      "" != i &&
                      (n.prop("disabled", !0),
                      $.post(window.location.href, { message: a, number: i, id: e, sms_gateway_test: !0 })
                          .done(function (e) {
          ...
          $("body").on("shown.bs.modal", "#__todo", function () {
              var e = $("#__todo");
              e.find('textarea[name="description"]').focus(),
                  "" !== e.find('input[name="todoid"]').val() ? (e.find(".add-title").addClass("hide"), e.find(".edit-title").removeClass("hide")) : (e.find(".add-title").removeClass("hide"), e.find(".edit-title").addClass("hide"));
          }),
          ...
          $("body").on("change", '[name="repeat_every"], [name="recurring"]', function () {
              var e = $(this).val();
              "custom" == e ? $(".recurring_custom").removeClass("hide") : $(".recurring_custom").addClass("hide"),
                  "" !== e && 0 != e
                      ? $("body").find("#cycles_wrapper").removeClass("hide")
                      : ($("body").find("#cycles_wrapper").addClass("hide"), $("body").find("#cycles_wrapper #cycles").val(0), $("#unlimited_cycles").prop("checked", !0).change());
          }),
          $("body").on("change", "#mass_select_all", function () {
              var e, t, a;
              (e = $(this).data("to-table")),
                  (t = $(".table-" + e).find("tbody tr")),
                  (a = $(this).prop("checked")),
                  $.each(t, function () {
          ...
          $("body").on("show.bs.modal", ".modal.email-template", function () {
              init_editor($(this).data("editor-id"), { urlconverter_callback: "merge_field_format_url" });
          }),
          ...
          $(".open-customizer").on("click", function (e) {
              e.preventDefault(),
                  setup_menu.hasClass("true" == isRTL ? "fadeOutRight" : "fadeOutLeft") && setup_menu.removeClass("true" == isRTL ? "fadeOutRight" : "fadeOutLeft"),
                  setup_menu.addClass("display-block " + ("true" == isRTL ? "fadeInRight" : "fadeInLeft")),
                  is_mobile() || requestGet("misc/set_setup_menu_open"),
                  mainWrapperHeightFix();
          }),
          $("body").on("click", ".cpicker", function () {
              ...
              $(this).parents(".cpicker-wrapper").find(".cpicker-big").removeClass("cpicker-big").addClass("cpicker-small"),
                  ...
                  $(this).hasClass("kanban-cpicker")
                      ? ($(this).parents(".panel-heading").css("background", e),
                        $(this)
                            .parents(".panel-heading")
                            .css("border", "1px solid " + e))
                      : $(this).hasClass("calendar-cpicker") && $("body").find('._event input[name="color"]').val(e);
          }),
          ...
          $("body").on("click" + ("ontouchstart" in window ? " touchstart" : ""), ".notifications a.notification-top, .notification_link", function (e) {
              ...
              a.hasClass("desktopClick") || a.parent("li").find(".not-mark-as-read-inline").click(),
                  s &&
                      setTimeout(function () {
          ...
          $(".notifications-wrapper").on("show.bs.dropdown", function () {
              notifications_wrapper.find(".notifications").attr("data-total-unread") > 0 &&
                  $.post(admin_url + "misc/set_notifications_read").done(function (e) {
          ...
          (table_activity_log = $("table.table-activity-log")).length)
      ) {
          var u = [];
      ...
      if (((table_invoices = $("table.table-invoices")), (table_estimates = $("table.table-estimates")), table_invoices.length > 0 || table_estimates.length > 0)) {
          ...
          $.each(h, function () {
              ...
              table_invoices.length &&
                  initDataTable(
                      table_invoices,
                      admin_url + "invoices/table" + ($("body").hasClass("recurring") ? "?recurring=1" : ""),
                      "undefined",
                      "undefined",
                      f,
              ...
              table_estimates.length &&
                  initDataTable(table_estimates, admin_url + "estimates/table", "undefined", "undefined", f, [
                      [3, "desc"],
                      [0, "desc"],
                  ]);
      }
      if ((table_tasks = $(".table-tasks")).length) {
          ...
          $("body").hasClass("tasks-page") && (k += "?bulk_actions=true"),
              (_table_api = initDataTable(table_tasks, k, g, g, b, [table_tasks.find("th.duedate").index(), "asc"])),
              _table_api && $("body").hasClass("dashboard") && _table_api.column(5).visible(!1, !1).column(6).visible(!1, !1).columns.adjust();
      }
      $("#send_file").on("show.bs.modal", function (e) {
          var t = $("#send_file");
          t.find('input[name="filetype"]').val($($(e.relatedTarget)).data("filetype")),
              t.find('input[name="file_path"]').val($($(e.relatedTarget)).data("path")),
              t.find('input[name="file_name"]').val($($(e.relatedTarget)).data("file-name")),
              $('input[name="email"]').length > 0 && t.find('input[name="send_file_email"]').val($('input[name="email"]').val());
      }),
      ...
      $("body").on("click", ".open_newsfeed, .close_newsfeed", function (e) {
          e.preventDefault(),
              void 0 === $(this).data("close")
                  ? requestGet("newsfeed/get_data").done(function (e) {
                        $("#newsfeed").html(e), load_newsfeed(postid), init_newsfeed_form(), init_selectpicker(), init_lightbox();
                    })
                  : !0 === $(this).data("close") && (newsFeedDropzone.destroy(), $("#newsfeed").html(""), (newsfeed_posts_page = 0), (track_load_post_likes = 0), (track_load_comment_likes = 0), (postid = void 0)),
              $("#newsfeed").toggleClass("hide"),
              $("body").toggleClass("noscroll");
      }),
      $("[data-newsfeed-auto]").length > 0 && ($(window).width() > 769 ? $(".open_newsfeed.desktop").click() : $(".open_newsfeed.mobile").click()),
      $("body").on("keyup", ".comment-input input", function (e) {
      ...
      $("body").on("submit", "._transaction_form", function () {
          ...
          var e = $(this).find("table.items"),
              t = e.find(".main");
          return t.find('[name="description"]').length && t.find('[name="description"]').val().trim().length > 0 && t.find('[name="rate"]').val().trim().length > 0
              ? (e.before(
                ...
                $("html,body").animate({ scrollTop: $("#items-warning").offset().top }),
                !1)
              : e.length && 0 === e.find(".item").length
              ? (e.before('<div class="alert alert-warning mbot20" id="items-warning">' + app.lang.no_items_warning + "</div>"), $("html,body").animate({ scrollTop: $("#items-warning").offset().top }), !1)
              : (reorder_items(),
                $('select[name="currency"]').prop("disabled", !1),
                $('select[name="project_id"]').prop("disabled", !1),
                $('input[name="date"]').prop("disabled", !1),
                $(this).find(".transaction-submit").prop("disabled", !0),
                !0);
      }),
          $("body").on("click", ".transaction-submit", function () {
              ...
              t.valid() &&
                  (e.hasClass("save-as-draft")
                      ? t.append(hidden_input("save_as_draft", "true"))
                      : e.hasClass("save-and-send")
                      ? t.append(hidden_input("save_and_send", "true"))
                      : e.hasClass("save-and-record-payment")
                      ? t.append(hidden_input("save_and_record_payment", "true"))
                      : e.hasClass("save-and-send-later") && t.append(hidden_input("save_and_send_later", "true"))),
                  t.submit();
          }),
          $("body").on("submit", "#sales-notes", function () {
              var e = $(this);
              if ("" !== e.find('textarea[name="description"]').val())
                  return (
                      $.post(e.attr("action"), $(e).serialize()).done(function (t) {
                          e.find('textarea[name="description"]').val(""),
                              e.hasClass("estimate-notes-form")
                                  ? get_sales_notes(t, "estimates")
                                  : e.hasClass("invoice-notes-form")
                                  ? get_sales_notes(t, "invoices")
                                  : e.hasClass("proposal-notes-form")
                                  ? get_sales_notes(t, "proposals")
                                  : e.hasClass("contract-notes-form") && get_sales_notes(t, "contracts");
                      }),
                      !1
                  );
          }),
          ...
          $("body").on("change", 'div.invoice input[name="date"], div.estimate input[name="date"], div.proposal input[name="date"]', function () {
              ...
              if ((do_prefix_year(e), !($('input[name="isedit"]').length > 0))) {
                  ...
                  $("body").find("div.estimate").length > 0 ? ((a = admin_url + "estimates/get_due_date"), (t = "expirydate")) : $("body").find("div.proposal").length > 0 && ((a = admin_url + "proposals/get_due_date"), (t = "open_till")),
                      "" === e && $('input[name="' + t + '"]').val(""),
                      "" !== e &&
                          $.post(a, { date: e }).done(function (e) {
          ...
          "undefined" != typeof Dropbox &&
              $("#dropbox-chooser-sales").length > 0 &&
              ...
              new Dropzone(
                  ...
                  appCreateDropzoneOptions({
                      ...
                      success: function (e, t) {
                          t = JSON.parse(t);
                          var a,
                              i = $("body").find('input[name="_attachment_sale_type"]').val();
                          (a = "delete_" + i + "_attachment"),
                              "estimate" == i
                                  ? $("body").hasClass("estimates-pipeline")
                                      ? estimate_pipeline_open(t.rel_id)
                                      : init_estimate(t.rel_id)
                                  : "proposal" == i
                                  ? $("body").hasClass("proposals-pipeline")
                                      ? proposal_pipeline_open(t.rel_id)
                                      : init_proposal(t.rel_id)
                                  : "function" == typeof window["init_" + i] && window["init_" + i](t.rel_id);
                          var n = "";
                          (!0 !== t.success && "true" != t.success) ||
                              ((n += '<div class="display-block sales-attach-file-preview" data-attachment-id="' + t.attachment_id + '">'),
                              (n += '<div class="col-md-10">'),
                              (n += '<div class="pull-left"><i class="attachment-icon-preview fa-regular fa-file"></i></div>'),
                              (n += '<a href="' + site_url + "download/file/sales_attachment/" + t.key + '" target="_blank">' + t.file_name + "</a>"),
                              (n += '<p class="text-muted">' + t.filetype + "</p>"),
                              (n += "</div>"),
                              (n += '<div class="col-md-2 text-right">'),
                              (n += '<a href="#" class="text-danger" onclick="' + a + "(" + t.attachment_id + '); return false;"><i class="fa fa-times"></i></a>'),
                              (n += "</div>"),
                              (n += '<div class="clearfix"></div><hr/>'),
                              (n += "</div>"),
                              $("#sales_uploaded_files_preview").append(n));
                      },
                  })
              ),
          ...
          $("body").on("click", ".discount-total-type", function (e) {
              e.preventDefault(),
                  ...
                  $(this).hasClass("discount-type-percent")
                      ? ($(".input-discount-fixed").addClass("hide").val(0), $(".input-discount-percent").removeClass("hide"))
                      : ($(".input-discount-fixed").removeClass("hide"), $(".input-discount-percent").addClass("hide").val(0), $("#discount_percent-error").remove()),
                  calculate_total();
          }),
          ...
          $("body").on("change", 'input[name="discount_percent"],input[name="discount_total"]', function () {
              if ("" === $('select[name="discount_type"]').val() && 0 != $(this).val()) {
                  if (0 === $("td[id^='tax_id_']").length) return;
                  return (
          ...
          $("body").on("change", ".invoice #project_id", function () {
              ...
              if ("" !== e)
                  requestGetJSON("tasks/get_billable_tasks_by_project/" + e).done(function (t) {
                      _init_tasks_billable_select(t, e);
                  });
              else {
                  var t = $("#clientid").selectpicker("val");
                  "" !== t
                      ? requestGetJSON("tasks/get_billable_tasks_by_customer_id/" + t).done(function (e) {
          ...
          $("body").on("change", ".f_client_id #clientid", function () {
              var e = $(this).val(),
                  ...
                  a = t.html("").clone(),
                  i = $(".projects-wrapper");
              if ((t.selectpicker("destroy").remove(), (t = a), $("#project_ajax_search_wrapper").append(a), init_ajax_project_search_by_customer_id(), clear_billing_and_shipping_details(), !e))
                  return $("#merge").empty(), $("#expenses_to_bill").empty(), $("#invoice_top_info").addClass("hide"), i.addClass("hide"), !1;
              ...
              requestGetJSON("invoices/client_change_data/" + e + "/" + (n = void 0 === n ? "" : n)).done(function (e) {
                  ...
                  for (var n in (0 === a.length ? (e.expenses_bill_info = "") : a.html(e.expenses_bill_info),
                  "" !== e.merge_info || "" !== e.expenses_bill_info ? $("#invoice_top_info").removeClass("hide") : $("#invoice_top_info").addClass("hide"),
                  billingAndShippingFields))
                      billingAndShippingFields[n].indexOf("billing") > -1 &&
                          (billingAndShippingFields[n].indexOf("country") > -1
                              ? $('select[name="' + billingAndShippingFields[n] + '"]').selectpicker("val", e.billing_shipping[0][billingAndShippingFields[n]])
                              : billingAndShippingFields[n].indexOf("billing_street") > -1
                              ? $('textarea[name="' + billingAndShippingFields[n] + '"]').val(e.billing_shipping[0][billingAndShippingFields[n]])
                              : $('input[name="' + billingAndShippingFields[n] + '"]').val(e.billing_shipping[0][billingAndShippingFields[n]]));
                  for (var s in (empty(e.billing_shipping[0].shipping_street) || $('input[name="include_shipping"]').prop("checked", !0).change(), billingAndShippingFields))
                      billingAndShippingFields[s].indexOf("shipping") > -1 &&
                          (billingAndShippingFields[s].indexOf("country") > -1
                              ? $('select[name="' + billingAndShippingFields[s] + '"]').selectpicker("val", e.billing_shipping[0][billingAndShippingFields[s]])
                              : billingAndShippingFields[s].indexOf("shipping_street") > -1
                              ? $('textarea[name="' + billingAndShippingFields[s] + '"]').val(e.billing_shipping[0][billingAndShippingFields[s]])
                              : $('input[name="' + billingAndShippingFields[s] + '"]').val(e.billing_shipping[0][billingAndShippingFields[s]]));
                  init_billing_and_shipping_details();
                  var o = e.client_currency,
                      l = $("body").find('.accounting-template select[name="currency"]');
                  0 != (o = parseInt(o)) ? l.val(o) : l.val(l.data("base")),
                      _init_tasks_billable_select(e.billable_tasks, t.selectpicker("val")),
                      !0 === e.customer_has_projects ? i.removeClass("hide") : i.addClass("hide"),
                      l.selectpicker("refresh"),
                      init_currency();
              });
          }),
          0 === $("body").find('input[name="isedit"]').length && $('.f_client_id select[name="clientid"]').change(),
          $("body").on("click", "#get_shipping_from_customer_profile", function (e) {
              ...
              var a = $("#clientid").val();
              "" !== a &&
                  requestGetJSON("clients/get_customer_billing_and_shipping_details/" + a).done(function (e) {
                      $('textarea[name="shipping_street"]').val(e[0].shipping_street),
                          $('input[name="shipping_city"]').val(e[0].shipping_city),
                          $('input[name="shipping_state"]').val(e[0].shipping_state),
                          $('input[name="shipping_zip"]').val(e[0].shipping_zip),
                          $('select[name="shipping_country"]').selectpicker("val", e[0].shipping_country);
                  });
          }),
          ...
          $("body").on("change", 'input[name="invoices_to_merge[]"]', function () {
              var e = $(this).prop("checked"),
                  t = $(this).val();
              !0 === e
                  ? requestGetJSON("invoices/get_merge_data/" + t).done(function (e) {
                        $.each(e.items, function (e, a) {
                            "" !== a.rel_type &&
                                ("task" == a.rel_type ? $('input[name="task_id"]').val(a.item_related_formatted_for_input) : "expense" == a.rel_type && $('input[name="expense_id"]').val(a.item_related_formatted_for_input)),
                                _set_item_preview_custom_fields_array(a.custom_fields),
                                add_item_to_table(a, "undefined", t);
                        });
                    })
                  : $("body")
                        .find('[data-merge-invoice="' + t + '"]')
                        .remove();
          }),
