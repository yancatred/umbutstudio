...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="gdpr-right">
            ...
            <a href="<?php echo terms_url(); ?>" class="btn btn-primary"><?php echo _l('terms_and_conditions'); ?></a>
        </div>
    </div>
    <?php } ?>
    <div class="col-md-4">
        <div class="gdpr-right">
            ...
            <a href="<?php echo site_url('clients/profile'); ?>"
                class="btn btn-primary"><?php echo _l('edit_my_information'); ?></a>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="gdpr-right">
            ...
            <a href="#" data-toggle="modal" data-target="#dataRemoval"
                class="btn btn-primary"><?php echo _l('request_data_removal'); ?></a>
        </div>
    </div>
    <?php } ?>
    ...
    <div class="col-md-4">
        <div class="gdpr-right">
            ...
            <a href="<?php echo site_url('clients/export'); ?>"
                class="btn btn-primary"><?php echo _l('export_my_data'); ?></a>
        </div>
    </div>
    <?php } ?>
    ...
    <div class="col-md-4">
        <div class="gdpr-right">
            ...
            <a href="<?php echo contact_consent_url(get_contact_user_id()); ?>"
                class="btn btn-primary"><?php echo _l('gdpr_consent'); ?></a>
        </div>
    </div>
    <?php } ?>
</div>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary _delete"><?php echo _l('confirm'); ?></button>
            </div>
        </div>
        <!-- /.modal-content -->
        <?php echo form_close(); ?>
