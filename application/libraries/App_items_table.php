...
class App_items_table extends App_items_table_template
{
    ...
    public function html_headings()
    {
        ...
        $html .= '<th align="right">' . $this->rate_heading() . ' (RM)</th>';
        if ($this->show_tax_per_item()) {
            $html .= '<th align="right">' . $this->tax_heading() . '</th>';
        }
        $html .= '<th align="right">' . $this->amount_heading() . '(RM)</th>';
        $html .= '</tr>';
    ...
    public function pdf_headings()
    {
        ...
        $tblhtml = '<tr height="30" bgcolor="' . get_option('pdf_table_heading_color') . '" style="color:black;">';
        ...
        $tblhtml .= '<th width="' . $regularItemWidth . '%" align="right">' . $this->rate_heading() . '(RM)</th>';

        if ($this->show_tax_per_item()) {
            $tblhtml .= '<th width="' . $regularItemWidth . '%" align="right">' . $this->tax_heading() . '</th>';
        }

        $tblhtml .= '<th width="' . $regularItemWidth . '%" align="right">' . $this->amount_heading() . '(RM)</th>';
        $tblhtml .= '</tr>';
