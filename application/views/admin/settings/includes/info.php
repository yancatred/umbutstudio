...
<div class="table-responsive">
    <table class="table table-bordered" id="system-info">
        ...
        <tbody>
            ...
            <tr>
                <td class="bold">Session Table Rows</td>
                <td>
                    <?php
                    ...
                    <span class="<?= $class ?>"><?= number_format($totalSessions) ?></span>&nbsp;&nbsp;<a
                            class="text-danger" href="<?= admin_url('settings/clear_sessions') ?>">clear</a>&nbsp;&nbsp;(<span
                        >If you clear the sessions table, you and all other users maybe be logged-out and will need to login again.</span>)
                </td>
            </tr>
            <tr>
