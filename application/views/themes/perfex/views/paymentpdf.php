...
$receit_heading = '<div style="text-align:center; font-size:25px;">' . mb_strtoupper(_l('payment_receipt'), 'UTF-8') . '</div>';
$pdf->Ln(1);
$pdf->writeHTMLCell(0, '', '', '', $receit_heading, 0, 1, false, true, 'L', true);

// Bill to
$client_details .= '<b>' . _l('estimate_to') . ':</b>';
...
$left_info  = $swap == '1' ? $company_info : $client_details;
$right_info = $swap == '1' ? $client_details : $company_info; 
...
<tr height="30" style="color:#000000;" bgcolor="#d9d9d9">
